 ...
 * $("img.lazy").lazy();
 */
(function(c,a){var e=c.jQuery||c.Zepto,d=0,b=false;e.fn.Lazy=e.fn.lazy=function(h){return new f(this,h)};e.Lazy=e.lazy=function(r,h,p){if(e.isFunction(h)){p=h;h=[]}if(!e.isFunction(p)){return}r=e.isArray(r)?r:[r];h=e.isArray(h)?h:[h];var j=f.prototype.config,m=j._f||(j._f={});for(var q=0,k=r.length;q<k;q++){if(j[r[q]]===a||e.isFunction(j[r[q]])){j[r[q]]=p}}for(var o=0,n=h.length;o<n;o++){m[h[o]]=r[0]}};function g(A,E,B,G,y){var p=0,C=-1,l=-1,m=false,s="afterLoad",k="load",H="error",w="img",r="src",J="srcset",t="sizes",D="background-image";function q(){m=c.devicePixelRatio>1;B=v(B);if(E.delay>=0){setTimeout(function(){I(true)},E.delay)}if(E.delay<0||E.combined){G.e=j(E.throttle,function(K){if(K.type==="resize"){C=l=-1}I(K.all)});G.a=function(K){K=v(K);B.push.apply(B,K)};G.g=function(){return(B=e(B).filter(function(){return !e(this).data(E.loadedName)}))};G.f=function(M){for(var K=0;K<M.length;K++){var L=B.filter(function(){return this===M[K]});if(L.length){I(false,L)}}};I();e(E.appendScroll).on("scroll."+y+" resize."+y,G.e)}}function v(T){var V=E.defaultImage,K=E.placeholder,U=E.imageBase,R=E.srcsetAttribute,M=E.loaderAttribute,S=E._f||{};T=e(T).filter(function(){var W=e(this),X=F(this);return !W.data(E.handledName)&&(W.attr(E.attribute)||W.attr(R)||W.attr(M)||S[X]!==a)}).data("plugin_"+E.name,A);for(var L=0,N=T.length;L<N;L++){var P=e(T[L]),Q=F(T[L]),O=P.attr(E.imageBaseAttribute)||U;if(Q===w&&O&&P.attr(R)){P.attr(R,z(P.attr(R),O))}if(S[Q]!==a&&!P.attr(M)){P.attr(M,S[Q])}if(Q===w&&V&&!P.attr(r)){P.attr(r,V)}else{if(Q!==w&&K&&(!P.css(D)||P.css(D)==="none")){P.css(D,"url('"+K+"')")}}}return T}function I(O,W){if(!B.length){if(E.autoDestroy){A.destroy()}return}var V=W||B,N=false,R=E.imageBase||"",K=E.srcsetAttribute,U=E.handledName;for(var S=0;S<V.length;S++){if(O||W||i(V[S])){var L=e(V[S]),T=F(V[S]),P=L.attr(E.attribute),M=L.attr(E.imageBaseAttribute)||R,Q=L.attr(E.loaderAttribute);if(!L.data(U)&&(!E.visibleOnly||L.is(":visible"))&&((P||L.attr(K))&&((T===w&&(M+P!==L.attr(r)||L.attr(K)!==L.attr(J)))||(T!==w&&M+P!==L.css(D)))||Q)){N=true;L.data(U,true);h(L,T,M,Q)}}}if(N){B=e(B).filter(function(){return !e(this).data(U)})}}function h(Q,U,T,S){++p;var X=function(){o("onError",Q);n();X=e.noop};o("beforeLoad",Q);var N=E.attribute,L=E.srcsetAttribute,Y=E.sizesAttribute,P=E.retinaAttribute,K=E.removeAttribute,W=E.loadedName,V=Q.attr(P);if(S){var R=function(){if(K){Q.removeAttr(E.loaderAttribute)}Q.data(W,true);o(s,Q);setTimeout(n,1);R=e.noop};Q.off(H).one(H,X).one(k,R);if(!o(S,Q,function(Z){if(Z){Q.off(k);R()}else{Q.off(H);X()}})){Q.trigger(H)}}else{var M=e(new Image());M.one(H,X).one(k,function(){Q.hide();if(U===w){Q.attr(t,M.attr(t)).attr(J,M.attr(J)).attr(r,M.attr(r))}else{Q.css(D,"url('"+M.attr(r)+"')")}Q[E.effect](E.effectTime);if(K){Q.removeAttr(N+" "+L+" "+P+" "+E.imageBaseAttribute);if(Y!==t){Q.removeAttr(Y)}}Q.data(W,true);o(s,Q);M.remove();n()});var O=(m&&V?V:Q.attr(N))||"";M.attr(t,Q.attr(Y)).attr(J,Q.attr(L)).attr(r,O?T+O:null);M.complete&&M.trigger(k)}}function i(K){var L=K.getBoundingClientRect(),M=E.scrollDirection,O=E.threshold,N=((u()+O)>L.top)&&(-O<L.bottom),P=((x()+O)>L.left)&&(-O<L.right);if(M==="vertical"){return N}else{if(M==="horizontal"){return P}}return N&&P}function x(){return C>=0?C:(C=e(c).width())}function u(){return l>=0?l:(l=e(c).height())}function F(K){return K.tagName.toLowerCase()}function z(O,M){if(M){var K=O.split(",");O="";for(var L=0,N=K.length;L<N;L++){O+=M+K[L].trim()+(L!==N-1?",":"")}}return O}function j(K,N){var L,M=0;return function(P,R){var O=+new Date()-M;function Q(){M=+new Date();N.call(A,P)}L&&clearTimeout(L);if(O>K||!E.enableThrottle||R){Q()}else{L=setTimeout(Q,K-O)}}}function n(){--p;if(!B.length&&!p){o("onFinishedAll")}}function o(M,L,K){if((M=E[M])){M.apply(A,[].slice.call(arguments,1));return true}return false}if(E.bind==="event"||b){q()}else{e(c).on(k+"."+y,q)}}function f(m,h){var i=this,j=e.extend({},i.config,h),l={},k=j.name+"-"+(++d);i.config=function(o,n){if(n===a){return j[o]}j[o]=n;return i};i.addItems=function(n){l.a&&l.a(e.type(n)==="string"?e(n):n);return i};i.getItems=function(){return l.g?l.g():{}};i.update=function(n){l.e&&l.e({},!n);return i};i.force=function(n){l.f&&l.f(e.type(n)==="string"?e(n):n);return i};i.loadAll=function(){l.e&&l.e({all:true},true);return i};i.destroy=function(){e(j.appendScroll).off("."+k,l.e);e(c).off("."+k);l={};return a};g(i,j,m,l,k);return j.chainable?m:i}f.prototype.config={name:"lazy",chainable:true,autoDestroy:true,bind:"load",threshold:500,visibleOnly:false,appendScroll:c,scrollDirection:"both",imageBase:null,defaultImage:"data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==",placeholder:null,delay:-1,combined:false,attribute:"data-src",srcsetAttribute:"data-srcset",sizesAttribute:"data-sizes",retinaAttribute:"data-retina",loaderAttribute:"data-loader",imageBaseAttribute:"data-imagebase",removeAttribute:true,handledName:"handled",loadedName:"loaded",effect:"show",effectTime:0,enableThrottle:true,throttle:250,beforeLoad:a,afterLoad:a,onError:a,onFinishedAll:a};e(c).on("load",function(){b=true})})(window);/* lozad.js - v1.9.0 - 2019-02-09
* https://github.com/ApoorvSaxena/lozad.js
* Copyright (c) 2019 Apoorv Saxena; Licensed MIT */
!function(b,a){"object"==typeof exports&&"undefined"!=typeof module?module.exports=a():"function"==typeof define&&define.amd?define(a):b.lozad=a()}(this,function(){var c=Object.assign||function(g){for(var i=1;i<arguments.length;i++){var f=arguments[i];for(var b in f){Object.prototype.hasOwnProperty.call(f,b)&&(g[b]=f[b])}}return g},h="undefined"!=typeof document&&document.documentMode,e={rootMargin:"0px",threshold:0,load:function(i){if(!i){return}if("picture"===i.nodeName.toLowerCase()){var j=document.createElement("img");h&&i.getAttribute("data-iesrc")&&(j.src=i.getAttribute("data-iesrc")),i.getAttribute("data-alt")&&(j.alt=i.getAttribute("data-alt")),i.appendChild(j)}if("video"===i.nodeName.toLowerCase()&&!i.getAttribute("data-src")&&i.children){for(var f=i.children,b=void 0,g=0;g<=f.length-1;g++){(b=f[g].getAttribute("data-src"))&&(f[g].src=b)}i.load()}i.getAttribute("data-src")&&(i.src=i.getAttribute("data-src")),i.getAttribute("data-srcset")&&i.setAttribute("srcset",i.getAttribute("data-srcset")),i.getAttribute("data-background-image")&&(i.style.backgroundImage="url('"+i.getAttribute("data-background-image")+"')"),i.getAttribute("data-toggle-class")&&i.classList.toggle(i.getAttribute("data-toggle-class"))},loaded:function(){}};function a(b){if(!b){return}b.setAttribute("data-loaded",!0)}var d=function(b){if(b){return"true"===b.getAttribute("data-loaded")}};return function(){var p,k,l=0<arguments.length&&void 0!==arguments[0]?arguments[0]:".lozad",b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},v=c({},e,b),j=v.root,f=v.rootMargin,q=v.threshold,g=v.load,w=v.loaded,m=void 0;return window.IntersectionObserver&&(m=new IntersectionObserver((p=g,k=w,function(n,i){n.forEach(function(o){(0<o.intersectionRatio||o.isIntersecting)&&(i.unobserve(o.target),d(o.target)||(p(o.target),a(o.target),k(o.target)))})}),{root:j,rootMargin:f,threshold:q})),{observe:function(){for(var n=function(r){var o=1<arguments.length&&void 0!==arguments[1]?arguments[1]:document;return r instanceof Element?[r]:r instanceof NodeList?r:o.querySelectorAll(r)}(l,j),i=0;i<n.length;i++){d(n[i])||(m?m.observe(n[i]):(g(n[i]),a(n[i]),w(n[i])))}},triggerLoad:function(i){d(i)||(g(i),a(i),w(i))},observer:m}}});(function(){function k(p,q,t){return p.call.apply(p.bind,arguments)}function l(p,q,t){if(!p){throw Error()}if(2<arguments.length){var u=Array.prototype.slice.call(arguments,2);return function(){var v=Array.prototype.slice.call(arguments);Array.prototype.unshift.apply(v,u);return p.apply(q,v)}}return function(){return p.apply(q,arguments)}}function aC(p,q,t){aC=Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?k:l;return aC.apply(null,arguments)}var aD=Date.now||function(){return +new Date};function m(p,q){this.a=p;this.m=q||p;this.c=this.m.document}var n=!!window.FontFace;function aE(p,q,t,u){q=p.c.createElement(q);if(t){for(var v in t){t.hasOwnProperty(v)&&("style"==v?q.style.cssText=t[v]:q.setAttribute(v,t[v]))}}u&&q.appendChild(p.c.createTextNode(u));return q}function aF(p,q,t){p=p.c.getElementsByTagName(q)[0];p||(p=document.documentElement);p.insertBefore(t,p.lastChild)}function aG(p){p.parentNode&&p.parentNode.removeChild(p)}function aH(p,q,t){q=q||[];t=t||[];for(var u=p.className.split(/\s+/),v=0;v<q.length;v+=1){for(var w=!1,y=0;y<u.length;y+=1){if(q[v]===u[y]){w=!0;break}}w||u.push(q[v])}q=[];for(v=0;v<u.length;v+=1){w=!1;for(y=0;y<t.length;y+=1){if(u[v]===t[y]){w=!0;break}}w||q.push(u[v])}p.className=q.join(" ").replace(/\s+/g," ").replace(/^\s+|\s+$/,"")}function aA(p,q){for(var t=p.className.split(/\s+/),u=0,v=t.length;u<v;u++){if(t[u]==q){return !0}}return !1}function aB(p){if("string"===typeof p.f){return p.f}var q=p.m.location.protocol;"about:"==q&&(q=p.a.location.protocol);return"https:"==q?"https:":"http:"}function o(p){return p.m.location.hostname||p.a.location.hostname}function at(q,t,u){function v(){p&&w&&y&&(p(z),p=null)}t=aE(q,"link",{rel:"stylesheet",href:t,media:"all"});var w=!1,y=!0,z=null,p=u||null;n?(t.onload=function(){w=!0;v()},t.onerror=function(){w=!0;z=Error("Stylesheet failed to load");v()}):setTimeout(function(){w=!0;v()},0);aF(q,"head",t)}function au(p,q,t,u){var v=p.c.getElementsByTagName("head")[0];if(v){var w=aE(p,"script",{src:q}),y=!1;w.onload=w.onreadystatechange=function(){y||this.readyState&&"loaded"!=this.readyState&&"complete"!=this.readyState||(y=!0,t&&t(null),w.onload=w.onreadystatechange=null,"HEAD"==w.parentNode.tagName&&v.removeChild(w))};v.appendChild(w);setTimeout(function(){y||(y=!0,t&&t(Error("Script load timeout")))},u||5000);return w}return null}function av(){this.a=0;this.c=null}function aw(p){p.a++;return function(){p.a--;ax(p)}}function ay(p,q){p.c=q;ax(p)}function ax(p){0==p.a&&p.c&&(p.c(),p.c=null)}function az(p){this.a=p||"-"}az.prototype.c=function(p){for(var q=[],t=0;t<arguments.length;t++){q.push(arguments[t].replace(/[\W_]+/g,"").toLowerCase())}return q.join(this.a)};function ak(p,q){this.c=p;this.f=4;this.a="n";var t=(q||"n4").match(/^([nio])([1-9])$/i);t&&(this.a=t[1],this.f=parseInt(t[2],10))}function r(p){return al(p)+" "+(p.f+"00")+" 300px "+am(p.c)}function am(p){var q=[];p=p.split(/,\s*/);for(var t=0;t<p.length;t++){var u=p[t].replace(/['"]/g,"");-1!=u.indexOf(" ")||/^\d/.test(u)?q.push("'"+u+"'"):q.push(u)}return q.join(",")}function an(p){return p.a+p.f}function al(p){var q="normal";"o"===p.a?q="oblique":"i"===p.a&&(q="italic");return q}function s(p){var q=4,t="n",u=null;p&&((u=p.match(/(normal|oblique|italic)/i))&&u[1]&&(t=u[1].substr(0,1).toLowerCase()),(u=p.match(/([1-9]00|normal|bold)/i))&&u[1]&&(/bold/i.test(u[1])?q=7:/[1-9]00/.test(u[1])&&(q=parseInt(u[1].substr(0,1),10))));return t+q}function c(p,q){this.c=p;this.f=p.m.document.documentElement;this.h=q;this.a=new az("-");this.j=!1!==q.events;this.g=!1!==q.classes}function d(p){p.g&&aH(p.f,[p.a.c("wf","loading")]);ao(p,"loading")}function ap(p){if(p.g){var q=aA(p.f,p.a.c("wf","active")),t=[],u=[p.a.c("wf","loading")];q||t.push(p.a.c("wf","inactive"));aH(p.f,t,u)}ao(p,"inactive")}function ao(p,q,t){if(p.j&&p.h[q]){if(t){p.h[q](t.c,an(t))}else{p.h[q]()}}}function e(){this.c={}}function f(p,q,t){var u=[],v;for(v in q){if(q.hasOwnProperty(v)){var w=p.c[v];w&&u.push(w(q[v],t))}}return u}function aq(p,q){this.c=p;this.f=q;this.a=aE(this.c,"span",{"aria-hidden":"true"},this.f)}function ar(p){aF(p.c,"body",p.a)}function ac(p){return"display:block;position:absolute;top:-9999px;left:-9999px;font-size:300px;width:auto;height:auto;line-height:normal;margin:0;padding:0;font-variant:normal;white-space:nowrap;font-family:"+am(p.c)+";"+("font-style:"+al(p)+";font-weight:"+(p.f+"00")+";")}function ad(p,q,t,u,v,w){this.g=p;this.j=q;this.a=u;this.c=t;this.f=v||3000;this.h=w||void 0}ad.prototype.start=function(){var p=this.c.m.document,q=this,t=aD(),u=new Promise(function(y,z){function w(){aD()-t>=q.f?z():p.fonts.load(r(q.a),q.h).then(function(A){1<=A.length?y():setTimeout(w,25)},function(){z()})}w()}),v=new Promise(function(w,y){setTimeout(y,q.f)});Promise.race([v,u]).then(function(){q.g(q.a)},function(){q.j(q.a)})};function ae(p,q,t,u,v,w,y){this.v=p;this.B=q;this.c=t;this.a=u;this.s=y||"BESbswy";this.f={};this.w=v||3000;this.u=w||null;this.o=this.j=this.h=this.g=null;this.g=new aq(this.c,this.s);this.h=new aq(this.c,this.s);this.j=new aq(this.c,this.s);this.o=new aq(this.c,this.s);p=new ak(this.a.c+",serif",an(this.a));p=ac(p);this.g.a.style.cssText=p;p=new ak(this.a.c+",sans-serif",an(this.a));p=ac(p);this.h.a.style.cssText=p;p=new ak("serif",an(this.a));p=ac(p);this.j.a.style.cssText=p;p=new ak("sans-serif",an(this.a));p=ac(p);this.o.a.style.cssText=p;ar(this.g);ar(this.h);ar(this.j);ar(this.o)}var af={D:"serif",C:"sans-serif"},ag=null;function ah(){if(null===ag){var p=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent);ag=!!p&&(536>parseInt(p[1],10)||536===parseInt(p[1],10)&&11>=parseInt(p[2],10))}return ag}ae.prototype.start=function(){this.f.serif=this.j.a.offsetWidth;this.f["sans-serif"]=this.o.a.offsetWidth;this.A=aD();g(this)};function h(p,q,t){for(var u in af){if(af.hasOwnProperty(u)&&q===p.f[af[u]]&&t===p.f[af[u]]){return !0}}return !1}function g(p){var q=p.g.a.offsetWidth,t=p.h.a.offsetWidth,u;(u=q===p.f.serif&&t===p.f["sans-serif"])||(u=ah()&&h(p,q,t));u?aD()-p.A>=p.w?ah()&&h(p,q,t)&&(null===p.u||p.u.hasOwnProperty(p.a.c))?ai(p,p.v):ai(p,p.B):i(p):ai(p,p.v)}function i(p){setTimeout(aC(function(){g(this)},p),50)}function ai(p,q){setTimeout(aC(function(){aG(this.g.a);aG(this.h.a);aG(this.j.a);aG(this.o.a);q(this.a)},p),0)}function aj(p,q,t){this.c=p;this.a=q;this.f=0;this.o=this.j=!1;this.s=t}var x=null;aj.prototype.g=function(p){var q=this.a;q.g&&aH(q.f,[q.a.c("wf",p.c,an(p).toString(),"active")],[q.a.c("wf",p.c,an(p).toString(),"loading"),q.a.c("wf",p.c,an(p).toString(),"inactive")]);ao(q,"fontactive",p);this.o=!0;j(this)};aj.prototype.h=function(p){var q=this.a;if(q.g){var t=aA(q.f,q.a.c("wf",p.c,an(p).toString(),"active")),u=[],v=[q.a.c("wf",p.c,an(p).toString(),"loading")];t||u.push(q.a.c("wf",p.c,an(p).toString(),"inactive"));aH(q.f,u,v)}ao(q,"fontinactive",p);j(this)};function j(p){0==--p.f&&p.j&&(p.o?(p=p.a,p.g&&aH(p.f,[p.a.c("wf","active")],[p.a.c("wf","loading"),p.a.c("wf","inactive")]),ao(p,"active")):ap(p.a))}function aU(p){this.j=p;this.a=new e;this.h=0;this.f=this.g=!0}aU.prototype.load=function(p){this.c=new m(this.j,p.context||this.j);this.g=!1!==p.events;this.f=!1!==p.classes;aV(this,new c(this.c,p),p)};function aW(p,q,t,u,v){var w=0==--p.h;(p.f||p.g)&&setTimeout(function(){var E=v||null,A=u||null||{};if(0===t.length&&w){ap(q.a)}else{q.f+=t.length;w&&(q.j=w);var y,C=[];for(y=0;y<t.length;y++){var B=t[y],D=A[B.c],F=q.a,z=B;F.g&&aH(F.f,[F.a.c("wf",z.c,an(z).toString(),"loading")]);ao(F,"fontloading",z);F=null;null===x&&(x=window.FontFace?(z=/Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent))?42<parseInt(z[1],10):!0:!1);x?F=new ad(aC(q.g,q),aC(q.h,q),q.c,B,q.s,D):F=new ae(aC(q.g,q),aC(q.h,q),q.c,B,q.s,E,D);C.push(F)}for(y=0;y<C.length;y++){C[y].start()}}},0)}function aV(p,q,t){var u=[],v=t.timeout;d(q);var u=f(p.a,t,p.c),w=new aj(p.c,q,v);p.h=u.length;q=0;for(t=u.length;q<t;q++){u[q].load(function(y,A,z){aW(p,w,y,A,z)})}}function aX(p,q){this.c=p;this.a=q}function aY(p,q,t){var u=aB(p.c);p=(p.a.api||"fast.fonts.net/jsapi").replace(/^.*http(s?):(\/\/)?/,"");return u+"//"+p+"/"+q+".js"+(t?"?v="+t:"")}aX.prototype.load=function(p){function q(){if(w["__mti_fntLst"+u]){var A=w["__mti_fntLst"+u](),C=[],y;if(A){for(var B=0;B<A.length;B++){var z=A[B].fontfamily;void 0!=A[B].fontStyle&&void 0!=A[B].fontWeight?(y=A[B].fontStyle+A[B].fontWeight,C.push(new ak(z,y))):C.push(new ak(z))}}p(C)}else{setTimeout(function(){q()},50)}}var t=this,u=t.a.projectId,v=t.a.version;if(u){var w=t.c.m;au(this.c,aY(t,u,v),function(y){y?p([]):(w["__MonotypeConfiguration__"+u]=function(){return t.a},q())}).id="__MonotypeAPIScript__"+u}else{p([])}};function aZ(p,q){this.c=p;this.a=q}aZ.prototype.load=function(u){var v,w,y=this.a.urls||[],z=this.a.families||[],A=this.a.testStrings||{},B=new av;v=0;for(w=y.length;v<w;v++){at(this.c,y[v],aw(B))}var q=[];v=0;for(w=z.length;v<w;v++){if(y=z[v].split(":"),y[1]){for(var p=y[1].split(","),t=0;t<p.length;t+=1){q.push(new ak(y[0],p[t]))}}else{q.push(new ak(y[0]))}}ay(B,function(){u(q,A)})};function a(p,q,t){p?this.c=p:this.c=q+b;this.a=[];this.f=[];this.g=t||""}var b="//fonts.googleapis.com/css";function aR(p,q){for(var t=q.length,u=0;u<t;u++){var v=q[u].split(":");3==v.length&&p.f.push(v.pop());var w="";2==v.length&&""!=v[1]&&(w=":");p.a.push(v.join(w))}}function aS(p){if(0==p.a.length){throw Error("No fonts to load!")}if(-1!=p.c.indexOf("kit=")){return p.c}for(var q=p.a.length,t=[],u=0;u<q;u++){t.push(p.a[u].replace(/ /g,"+"))}q=p.c+"?family="+t.join("%7C");0<p.f.length&&(q+="&subset="+p.f.join(","));0<p.g.length&&(q+="&text="+encodeURIComponent(p.g));return q}function aT(p){this.f=p;this.a=[];this.c={}}var aK={latin:"BESbswy","latin-ext":"\u00e7\u00f6\u00fc\u011f\u015f",cyrillic:"\u0439\u044f\u0416",greek:"\u03b1\u03b2\u03a3",khmer:"\u1780\u1781\u1782",Hanuman:"\u1780\u1781\u1782"},aL={thin:"1",extralight:"2","extra-light":"2",ultralight:"2","ultra-light":"2",light:"3",regular:"4",book:"4",medium:"5","semi-bold":"6",semibold:"6","demi-bold":"6",demibold:"6",bold:"7","extra-bold":"8",extrabold:"8","ultra-bold":"8",ultrabold:"8",black:"9",heavy:"9",l:"3",r:"4",b:"7"},aM={i:"i",italic:"i",n:"n",normal:"n"},aN=/^(thin|(?:(?:extra|ultra)-?)?light|regular|book|medium|(?:(?:semi|demi|extra|ultra)-?)?bold|black|heavy|l|r|b|[1-9]00)?(n|i|normal|italic)?$/;function aO(y){for(var z=y.f.length,A=0;A<z;A++){var B=y.f[A].split(":"),C=B[0].replace(/\+/g," "),D=["n4"];if(2<=B.length){var E;var t=B[1];E=[];if(t){for(var t=t.split(","),q=t.length,v=0;v<q;v++){var u;u=t[v];if(u.match(/^[\w-]+$/)){var w=aN.exec(u.toLowerCase());if(null==w){u=""}else{u=w[2];u=null==u||""==u?"n":aM[u];w=w[1];if(null==w||""==w){w="4"}else{var p=aL[w],w=p?p:isNaN(w)?"4":w.substr(0,1)}u=[u,w].join("")}}else{u=""}u&&E.push(u)}}0<E.length&&(D=E);3==B.length&&(B=B[2],E=[],B=B?B.split(","):E,0<B.length&&(B=aK[B[0]])&&(y.c[C]=B))}y.c[C]||(B=aK[C])&&(y.c[C]=B);for(B=0;B<D.length;B+=1){y.a.push(new ak(C,D[B]))}}}function aP(p,q){this.c=p;this.a=q}var aQ={Arimo:!0,Cousine:!0,Tinos:!0};aP.prototype.load=function(p){var q=new av,t=this.c,u=new a(this.a.api,aB(t),this.a.text),v=this.a.families;aR(u,v);var w=new aT(v);aO(w);at(t,aS(u),aw(q));ay(q,function(){p(w.a,w.c,aQ)})};function aI(p,q){this.c=p;this.a=q}aI.prototype.load=function(p){var q=this.a.id,t=this.c.m;q?au(this.c,(this.a.api||"https://use.typekit.net")+"/"+q+".js",function(y){if(y){p([])}else{if(t.Typekit&&t.Typekit.config&&t.Typekit.config.fn){y=t.Typekit.config.fn;for(var z=[],A=0;A<y.length;A+=2){for(var B=y[A],v=y[A+1],u=0;u<v.length;u++){z.push(new ak(B,v[u]))}}try{t.Typekit.load({events:!1,classes:!1,async:!0})}catch(w){}p(z)}}},2000):p([])};function aJ(p,q){this.c=p;this.f=q;this.a=[]}aJ.prototype.load=function(p){var q=this.f.id,t=this.c.m,u=this;q?(t.__webfontfontdeckmodule__||(t.__webfontfontdeckmodule__={}),t.__webfontfontdeckmodule__[q]=function(y,z){for(var w=0,A=z.fonts.length;w<A;++w){var v=z.fonts[w];u.a.push(new ak(v.name,s("font-weight:"+v.weight+";font-style:"+v.style)))}p(u.a)},au(this.c,aB(this.c)+(this.f.api||"//f.fontdeck.com/s/css/js/")+o(this.c)+"/"+q+".js",function(v){v&&p([])})):p([])};var aa=new aU(window);aa.a.c.custom=function(p,q){return new aZ(q,p)};aa.a.c.fontdeck=function(p,q){return new aJ(q,p)};aa.a.c.monotype=function(p,q){return new aX(q,p)};aa.a.c.typekit=function(p,q){return new aI(q,p)};aa.a.c.google=function(p,q){return new aP(q,p)};var ab={load:aC(aa.load,aa)};"function"===typeof define&&define.amd?define(function(){return ab}):"undefined"!==typeof module&&module.exports?module.exports=ab:(window.WebFont=ab,window.WebFontConfig&&aa.load(window.WebFontConfig))}());var strHost="https://profile.kenh14.vn";var strMingAuthenUrl="https://vietid.net/big4/request";var Constants={mingCheckSessionUrl:"https://vietid.net/login/Checksession",mingCommentHost:"https://comment.vietid.net",mingAppKey:"d9c694bd04eb35d96f1d71a84141d075",apiLiveDomain:"http://kenh14s.cnnd.vn",apiHandlerUrl:"https://kenh14s.cnnd.vn",host:"http://kenh14.vn",searchHost:"http://search.kenh14.vn",apiSignalRDomain:"http://sig.channelvn.net",videoHdDomain:"https://vcplayer.mediacdn.vn",videoStorage:"https://video-thumbs.mediacdn.vn"};var LC=readCookie("__RC")==4?1:2;function readCookie(f){var b=f+"=";var d,e=document.cookie.split(";");for(var a=0;a<e.length;a++){d=e[a];while(d.charAt(0)==" "){d=d.substring(1,d.length)}if(d.indexOf(b)==0){return d.substring(b.length,d.length)}}return null}function createCookie(e,a,c){if(c){var d=new Date();d.setTime(d.getTime()+(c*24*60*60*1000));var b="; expires="+d.toGMTString()}else{var b=""}document.cookie=e+"="+a+b+"; path=/"}function eraseCookie(a){createCookie(a,"",-1)}function MingToolbarCallback(a){if(typeof(Funny_LoginCallback)=="function"){Funny_LoginCallback(a)}if(typeof(getVoteStyle_LoginCallback)=="function"){getVoteStyle_LoginCallback()}if(typeof(Profile_LoginCallback)=="function"){Profile_LoginCallback()}}String.prototype.trimStart=function(b){b=b?b:" ";var a=0;for(;a<this.length&&this.charAt(a)==b;a++){}return this.substring(a)};var mobileRedirect={isDebug:false,init:function(){try{if(typeof(Storage)!=="undefined"){var a=sessionStorage.getItem("VisitSession");if(a==null){sessionStorage.setItem("VisitSession","1");var c=window.location.hash;if(c==="#first"){this.removeHash()}else{eraseCookie("browser");if(navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|Windows Phone|webOS)/i)!=null){window.location=window.location.href}}}else{}}}catch(b){if(this.isDebug){console.log(b)}}},removeHash:function(){window.history.replaceState("","",window.location.href.split("#")[0])}};function isSmartPhone(){return(navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|Windows Phone|webOS)/i)!=null)}var detectmob=function(){if(navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/BlackBerry/i)||navigator.userAgent.match(/Windows Phone/i)){return true}else{return false}};function getParameterByName(d,a){if(!a){a=window.location.href}d=d.replace(/[\[\]]/g,"\\$&");var b=new RegExp("[?&]"+d+"(=([^&#]*)|&|#|$)"),c=b.exec(a);if(!c){return null}if(!c[2]){return""}return decodeURIComponent(c[2].replace(/\+/g," "))}var fbClient={version:"v2.3",appId:"1506977592847257",xfbml:true,status:true,likeCB:null,loaded:null,init:function(){var a=this;$(document).ready(function(){if($("#fb-root").length===0){$("body").prepend('<div id="fb-root"></div>')}a.fbLoad("//connect.facebook.net/vi_VN/sdk.js",function(){FB.init({appId:a.appId,status:a.status,xfbml:a.xfbml,version:a.version});FB.Event.subscribe("xfbml.render",a.renderButton)})})},fbParse:function(b){try{FB.XFBML.parse(b)}catch(a){}},fbLoad:function(b,a){a=(typeof a!="undefined")?a:{};$.ajax({type:"GET",url:b,success:a,dataType:"script",cache:true})},getLikeShareCount:function(a,d,b,c){$.ajax({type:"GET",dataType:"json",url:"https://sharefb.cnnd.vn/?urls="+a,success:function(e){if($(d)!=null){$(d).html(e[0].share_count)}if($(b)!=null){$(b).html(e[0].like_count)}if($(c)!=null){$(c).html(e[0].total_count)}}})},shareClick:function(e){var c=screen.width/2-700/2;var d=screen.height/2-450/2;var b=e!=null?e:document.location.href;var a=window.open("https://www.facebook.com/sharer.php?u="+b,"chia sẻ","toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=700, height=485, top="+d+", left="+c);a.focus();return false},sendClick:function(b){var a=b!=null?b:document.location.href;FB.ui({method:"send",link:a,});return false},fanpage:function(){setTimeout(function(){if(!$(".social-share .fb-like iframe").is(":visible")){$(".social-share").remove()}},10000)},renderButton:function(){$(".k14-fb-like").remove();$(".btn-fb-send").remove();$(".fb-send").removeClass("hidden").show().parent(".fbSendWrap").children(':not(".fb-send")').remove();$(".fb-like").removeClass("hidden").show().parent(".fbLikeWrap").children(':not(".fb-like")').remove()},likeOnload:function(c,b,a){$(c).css({display:"block",width:b,height:a})}};if(document.location.hostname.indexOf(".tk")>0){document.location=Constants.host}$(function(){$(".btn-faq-popup").fancybox({width:1000,padding:0});$(".btn-view-map").fancybox({width:800,padding:0})});function isElementVisible(f){if(f==null){return}var c=f.getBoundingClientRect(),d=window.innerHeight||doc.documentElement.clientHeight;var b=(c.top>=0&&c.top<=d);var e=(c.bottom>=0&&c.bottom<=d);var a=(c.bottom-(f.clientHeight-(f.clientHeight/2))>=0&&c.bottom<=d);if(b&&a){return"play"}else{if(!b&&!a){return"pause"}}return""}var videoHD={typeAppend:1,isMute:false,isSuggest:true,isAd:true,isHideControlbar:false,originDomain:"*",suggsetDomain:Constants.apiHandlerUrl+"/Handler/Video/ListVideoXML.ashx?watch=",divVideoFormat:'<div class="VCSortableInPreviewMode" type="VideoStream"></div>',divIfrWrapperFormat:'<div class="iframe-wraper"></div>',videoFormat:'<div class="iframe-wraper">{4}<iframe width="{0}" height="{1}" src="{2}" id="ifVideo-{3}" frameborder="0" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" oallowfullscreen="" msallowfullscreen="" oallowfullscreen="" scrolling="no"></iframe></div>',bgFormat:'<div class="bg-wraper" style="background-image: url({0});"><div class="loading-vid-icon"><div class="lvc-label">{1}</div><div class="lvc-play-icon"></div></div><div class="loading-vid-countdown" style="display: none"><div class="lvc-label">{1}</div><div class="lvc-circle"></div><div class="lvc-line-mask"><div class="lvc-line"></div></div><span style="display: none;"class="lvc-number">3</span></div></div>',bgText:"Video tự động phát",bgPauseNotify:'<div class="pause-vd-notify" style="display: none;"><span class="clearfix"><svg width="9" height="12"><path d="M0,0V12H3V0ZM6,0V12H9V0Z"></path></svg>Video tạm dừng</span></div>',host:Constants.videoHdDomain+"/1.1/?_site=kenh14&vid=kenh14/",useBg:true,videoStorage_ext:"https://video-thumbs-ext.mediacdn.vn",videoStorage:"https://video-thumbs.mediacdn.vn",init:function(b,d){var a=this;if(typeof(d)=="undefined"){d={}}if(typeof(d.useBg)!="undefined"){a.useBg=d.useBg}var e;if(d.type){e=a.getVideoType(d.type);if(e.playType==a.playType.clickToPlay||e.playType==a.playType.autoplay){a.useBg=false}}if(d.isAd){a.isAd=d.isAd}if(d.isHideControlbar){a.isHideControlbar=d.isHideControlbar}if(detectmob()||!a.useBg){a.bgPauseNotify=""}$(b).find(".VCSortableInPreviewMode[type=VideoStream]").each(function(){var g=$(this);if(g.find(".videoNewsPlayer").length>0){return}var f=g.attr("videoid");g.find('>div[videoid="'+f+'"]').remove();g.find('iframe[src*="vcplayer.vcmedia.vn"], iframe[src*="123.31.11.105"], iframe[src*="vcplayer.mediacdn.vn"]').remove();setTimeout(function(){a.initnew(g,e,d)},300)});var c=$(b).find('iframe[src*="vcplayer.vcmedia.vn"], iframe[src*="123.31.11.105"], iframe[src*="vcplayer.mediacdn.vn"]');c.each(function(m,f){var h=$(this);if(h.is(":visible")){if(typeof(h.attr("id"))=="undefined"){var o=m;var g="ifVideo-"+o;while($('iframe[id="'+g+'"]').length>0){o=Math.floor((Math.random()*1000)+1);g="ifVideo-"+o}h.attr("id",g);var j=h.attr("src");j=a.genVideoSource(j,o,e);if(j!=""){h.attr("src",j.replace("https://","http://"));h.attr("playType",getParameterByName("playType",j));if(a.useBg&&!detectmob()){var p=h.parent();if(!h.parent().hasClass("VCSortableInPreviewMode")){p=$(a.divVideoFormat);h.after(p)}else{if(p.hasClass("VCSortableInPreviewMode")&&p.attr("type")=="insertembedcode"){p.attr("type","VideoStream")}}var i=$(a.divIfrWrapperFormat);p.append(i);p.addClass("pos-rlt");p.find(".iframe-wraper").append(a.bgPauseNotify);p.find(".iframe-wraper").append(h);var n=getParameterByName("vid",j);var k=Constants.videoStorage+"/thumb_w/650/"+n.toLowerCase().substring(0,n.lastIndexOf("."))+".jpg";var l=String.format(a.bgFormat,k,a.bgText);p.append(l);p.find(".bg-wraper").height(p.find("iframe").height())}}}}});$(b).find(".VCSortableInPreviewMode[type=VideoStream] .bg-wraper").each(function(){var f=$(this);f.click(function(){var g=f.parents(".VCSortableInPreviewMode");admPlayNow(g)})})},initnew:function(c,t,a){var u=this;var m=$(c);var s=m.attr("data-width");var B=m.attr("data-height");var v=m.attr("data-vid");var q=m.attr("data-location");var z=m.attr("data-info");var o=m.attr("data-autoplay")=="true";var C=m.attr("data-thumb");var n=m.attr("data-ads");var r=m.attr("data-replay");var b=m.attr("data-postroll");C=u.image_thumb_w(C,650);var D=window.location.href;if(D.indexOf("?")!=-1){D=D.substr(0,D.indexOf("?"))}var l="";var f="";var j="";var y=m.attr("data-contentId");var A=m.attr("data-namespace");if(typeof A=="undefined"||A==""){A="kenh14"}try{if(typeof v!="undefined"){if(!v.startsWith(A+"/")&&!v.startsWith("kingcontent/")){v=A+"/"+v}}}catch(p){console.log("vidAttr err: ",p)}if(t){l=t.isMute;f=t.vtype;j=t.playType;if(t.playType==u.playType.autoplay){o=true}}if(m.attr("embed-type")!="4"){var w=m.attr("data-src");if(typeof(w)!="undefined"){v=getParameterByName("vid",w);m.attr("data-vid",v);var E=getParameterByName("autoplay",w);if(E!=null){o=E=="true"}}z=m.attr("videoid");C=getParameterByName("poster",w);if(typeof C!="undefined"&&C!=""&&C!=null){C=u.image_thumb_w(C,620)}if(typeof(q)=="undefined"){q=""}}var h="";var d=playerInitScript.getPlayers();if(typeof d!="undefined"){var g=d["#streamid_"+z];if(typeof d!="undefined"){h="_"+getRandomeString()}}m.prepend('<video id="streamid_'+z+h+'" class="videoNewsPlayer" playsinline="" webkit-playsinline="" height="'+B+'" width="'+s+'"></video>');var x={vid:v,autoplay:o,location:q,_info:z,shareUrl:D,mute:l,vtype:f,playType:j,nopre:true,poster:C};if(n=="true"||n=="True"||typeof n=="undefined"){x.midroll="0.8;20s"}if(b=="true"||b=="True"||typeof b=="undefined"){x.postroll=true}if(r=="true"||r=="True"||t.replay){x.replay="true"}try{var k="";playerInitScript("streamid_"+z+h,{params:x,secure:k},function(){var e=this;if(typeof(a.functionCallBack)=="function"){a.functionCallBack()}})}catch(i){console.log(i)}},image_thumb_w:function(a,e){if(typeof a=="undefined"||a==""){return}var d=this;if(e==0||typeof e=="undefined"){return a}var c=/thumb_w\/\d+\//g;a=a.replace(c,"");var b=d.videoStorage;if(a.indexOf(d.videoStorage_ext)!=-1||a.indexOf("http://video-thumbs-ext.mediacdn.vn")!=-1){b=d.videoStorage_ext;a=a.replace(d.videoStorage_ext,"");a=a.replace("http://video-thumbs-ext.mediacdn.vn","")}else{if(a.indexOf(d.videoStorage)!=-1){a=a.replace(d.videoStorage,"")}if(a.indexOf("http://video-thumbs.mediacdn.vn")!=-1){a=a.replace("http://video-thumbs.mediacdn.vn","")}if(a.indexOf("http://video-thumbs.vcmedia.vn")!=-1){a=a.replace("http://video-thumbs.vcmedia.vn","")}if(a.indexOf("https://video-thumbs.mediacdn.vn")!=-1){a=a.replace("https://video-thumbs.mediacdn.vn","")}if(a.indexOf("http://kenh14cdn.com")!=-1){a=a.replace("http://kenh14cdn.com","");return String.format("{0}/thumb_w/{1}/{2}","http://kenh14cdn.com",e,a.trimStart("/"))}if(a.indexOf("https://kenh14cdn.com")!=-1){a=a.replace("https://kenh14cdn.com","");return String.format("{0}/thumb_w/{1}/{2}","https://kenh14cdn.com",e,a.trimStart("/"))}if(a.startsWith("http")){return a}}return String.format("{0}/thumb_w/{1}/{2}",b,e,a.trimStart("/"))},getPlayerToken:function(c,d){var a=this;var b;$.ajax({async:false,url:DomainConfig.AjaxDomain+"/Handlers/Video/getPlayerToken.ashx",xhrFields:{withCredentials:true},data:{content_id:c,apinamespace:d},type:"POST",dataType:"json",success:function(e){if(e.Success){b=$.parseJSON(e.Data)}}});return b},buildEmbedVideo:function(c,d,i,a,h,f){var g=this;var e=g.host+a;e+="&_info="+h;var b="0;0;0;0";if(typeof admParamTvc==="function"){b=admParamTvc(0)}e+="&_admParamTvc="+b;if(f){e+="&autoplay="+f}if(g.isSuggest){e+="&_listsuggest="+g.suggsetDomain+i}return String.format(g.videoFormat,c,d,e,i,g.bgPauseNotify)},videoFunction:function(c,d){var a=this;var b;switch(d){case"play":b={action:"play"};$(c).get(0).contentWindow.postMessage(b,a.originDomain);break;case"pause":b={action:"pause"};$(c).get(0).contentWindow.postMessage(b,a.originDomain);break}},listFocus:function(b,j,a,c){var f=this;if($(b).hasClass("playing")){return}$(b).parent().find("li").removeClass("playing");$(b).addClass("playing");var i=$(b).attr("data-id");var d=$(b).attr("data-filename");var g=$(b).attr("data-key");var e=f.buildEmbedVideo(j,a,i,d,g,true);if(c!=null){$(c).html(e)}else{$("#video-player-wrapt").html(e)}},genVideoSource:function(a,b,d){if(a=="undefined"||a==null){return""}var e=this;if(d){if(a.indexOf("mute")<0){a+="&mute="+d.isMute}if(a.indexOf("vtype")<0){a+="&vtype="+d.vtype}if(a.indexOf("playType")<0){a+="&playType="+d.playType}if(d.playType==e.playType.autoplay){a+="&autoplay=true"}}a=a.replace("http://vcplayer.mediacdn.vn",Constants.videoHdDomain);a=a.replace("&amp;","&").replace("_tag=http://vscc.hosting.vcmedia.vn/tag/","_info=");var f="0;0;0;0";if(typeof admParamTvc==="function"){f=admParamTvc(0)}a+="&_admParamTvc="+f;if(e.isSuggest){a+="&_listsuggest="+e.suggsetDomain+b}if(e.isHideControlbar){a+="&_controlbar=hide"}if(a.indexOf("postroll")<0&&d!=e.videoType.videoDetail){a+="&postroll=true"}if(a.indexOf("replay")<0){a+="&replay=true"}if(a.indexOf("nonVol")<0){a+="&nonVol=true"}if(a.indexOf("volume")<0){a+="&volume=0.6"}var c=getParameterByName("boxVideoID",a);a=a.replace("&boxVideoID="+c,"");a+="&boxVideoID=ifVideo-"+b;if(detectmob()){a=a.replace("&nopre=true","");a=a.replace("&midroll=0.8;20s","")}else{if(a.indexOf("nopre")<0){a+="&nopre=true"}if(!e.isAd){a+="&tag=0";a=a.replace("&midroll=0.8;20s","")}else{if(a.indexOf("midroll")<0){a+="&midroll=0.8;20s"}}}return a},playType:{viewable:0,autoplay:1,clickToPlay:2},videoType:{newsDetail:1,stream:2,videoDetail:3,boxVideo:4,newsBottom:5,boxMutex:6,clickToPlay:7,zoneVideo:8},getVideoType:function(b){var a=this;switch(b){case 1:return{vtype:"1",position:"bài chi tiết",playType:a.playType.viewable,isMute:false,note:"",replay:true};break;case 2:return{vtype:"2",position:"stream",playType:a.playType.viewable,isMute:true,note:"",replay:true};break;case 3:return{vtype:"3",position:"video chi tiết",playType:a.playType.autoplay,isMute:false,note:""};break;case 4:return{vtype:"4",position:"box cắt ngang",playType:a.playType.viewable,isMute:true,note:"unmute khi mở popup",replay:true};break;case 5:return{vtype:"5",position:"video chân bài",playType:a.playType.viewable,isMute:true,note:"unmute khi mở popup",replay:true};break;case 6:return{vtype:"6",position:"box mutex",playType:a.playType.viewable,isMute:true,note:"",replay:true};break;case 7:return{vtype:"7",position:"video ấn mới chạy",playType:a.playType.clickToPlay,isMute:false,note:""};break;case 8:return{vtype:"8",position:"chuyên mục video",playType:a.playType.viewable,isMute:true,note:"",replay:true};break;default:return{vtype:"2",position:"stream",playType:a.playType.viewable,isMute:true,note:"",replay:true};break}}};function admPlayNow(b){var c=$(b);var a=c.find('iframe[src*="vcplayer.vcmedia.vn"], iframe[src*="123.31.11.105"], iframe[src*="vcplayer.mediacdn.vn"]');if($.inArray("#"+a.attr("id"),readyVideoIds)>=0){videoInContent.playVideo(a)}else{waitingVideoIdForReady.push("#"+a.attr("id"))}c.find(".bg-wraper").hide()}var videoIframe={arrIframe:[],originDomain:"*",rangerPixel:40,fraction:0.6,videoDomain:"https://vscc-kenh14-hosting.vcmedia.vn",timeOut:null,init:function(b){var a=this;a.pushArrIframe(b);$(window).scroll(function(){var l=$(this).scrollTop();for(var n=0;n<a.arrIframe.length;n++){var o=$(a.arrIframe[n]);var d=o.offset().left,e=o.offset().top,p=o.width(),c=o.height(),k=d+p,j=e+c,g,f,m;g=Math.max(0,Math.min(p,window.pageXOffset+window.innerWidth-d,k-window.pageXOffset));f=Math.max(0,Math.min(c,l+window.innerHeight-e,j-l));m=f/c;if(m>a.fraction){if(!o.hasClass("play")){o.addClass("play");a.videoFunction(o,"showSpin")}}else{if(o.attr("data-layout")!="first-scroll"){o.removeClass("play");a.videoFunction(o,"showNote")}}}})},pushArrIframe:function(b){var a=this;a.arrIframe=[];$(b).find('iframe[src*="vcmedia.vn"][data-layout="scroll"],[src*="vcmedia.vn"][data-layout="trailer"],[src*="vcmedia.vn"][data-layout="first-scroll"]').each(function(){a.arrIframe.push($(this))})},videoFunction:function(b,c){var a=this;switch(c){case"showSpin":$(b).get(0).contentWindow.postMessage("showSpin()",a.originDomain);break;case"showNote":$(b).get(0).contentWindow.postMessage("showNote()",a.originDomain);break;case"playVideo":$(b).get(0).contentWindow.postMessage("playVideo()",a.originDomain);break;case"pauseVideo":$(b).get(0).contentWindow.postMessage("pauseVideo()",a.originDomain);break}},openPopup:function(o,m,n){var b=this;if($(".video-zoom-wrap").length>0){$(".video-zoom-wrap").remove()}b.videoFunction($("#"+o),"pauseVideo");var h=720;var c=window.innerWidth;var s=window.innerHeight;var j=150;var d=$(document).scrollTop();var l=c<h?c-j:h;var g=Math.round(l*9/16);var q=(c-l)/2;var k=(s-g)/2;var a=String.format('<iframe style="opacity:0" width="{0}" height="{1}" src="{3}/embed/{2}?autostart=true" frameborder="0" scrolling="no" allowfullscreen=""></iframe>',l,g,n,b.videoDomain);m=String.format('<img style="width:200px;height:100px;margin-top:{0}px;margin-left:{1}px" src="'+m+'" alt="" />',(g-100)/2,(l-200)/2);var f=l/200;var r='<div class="video-zoom-wrap">'+m+'<div class="video-zoom-overlay"></div></div>';var e=$("#"+o).parent("div");e.css("position","relative").append(r);$("body").css("overflow-x","hidden");var p=(0-e.offset().left)+(c-l)/2;var i=(d-e.offset().top)+(s-g)/2;$(".video-zoom-overlay").css("opacity","1");$(".video-zoom-overlay").css({width:c,height:s,left:"-"+(e.offset().left+p)+"px",top:"-"+k+"px"});$(".video-zoom-wrap").find("img").css("transform","scale("+f+")");$(".video-zoom-wrap").append(a);setTimeout(function(){$(".video-zoom-wrap img").hide();$(".video-zoom-wrap iframe").css("opacity","1")},300);$(".video-zoom-wrap").css("transform","translate("+p+"px, "+i+"px) translateZ(0px)");$(".video-zoom-overlay").click(function(){b.closePopup(o);return false});$(window).scroll(function(){b.closePopup(o)})},closePopup:function(b){var a=this;if($(".video-zoom-wrap").length>0){$("body").css("overflow-x","auto");var c=$(".video-zoom-wrap");$(".video-zoom-overlay").css("opacity","0");$(".video-zoom-wrap iframe").hide();$(".video-zoom-wrap img").show();setTimeout(function(){$(".video-zoom-wrap img").css("transform","scale(1)");c.css("transform","translate(0px, 0px) translateZ(0px)")},100);setTimeout(function(){c.remove();a.videoFunction($("#"+b),"showSpin")},300)}},supportTransition:function(){var a=document.body||document.documentElement,c=a.style,b=c.transition!==undefined||c.WebkitTransition!==undefined||c.MozTransition!==undefined||c.MsTransition!==undefined||c.OTransition!==undefined;return b},tabActive:function(){var a=this;var c=$('iframe[src*="vcmedia.vn"][src*="autoSpin=true"][data-layout="first-scroll"], [src*="vcmedia.vn"][src*="autoSpin=true"][data-layout="scroll"]');if(c.length>0){var b=(function(){var e,f,d={hidden:"visibilitychange",webkitHidden:"webkitvisibilitychange",mozHidden:"mozvisibilitychange",msHidden:"msvisibilitychange"};for(e in d){if(e in document){f=d[e];break}}return function(g){if(g){document.addEventListener(f,g)}return !document[e]}})();b(function(){if(b()){c.get(0).contentWindow.postMessage("FocusTab(true)",a.originDomain)}else{c.get(0).contentWindow.postMessage("FocusTab(false)",a.originDomain)}});if(b()){a.timeOut=setInterval(function(){c.get(0).contentWindow.postMessage("FocusTab(true)",a.originDomain)},500)}else{c.get(0).contentWindow.postMessage("FocusTab(false)",a.originDomain)}}},clearFocus:function(){clearInterval(this.timeOut)}};window.addEventListener?window.addEventListener("message",function(a){listenPlayer(a)},!1):window.attachEvent&&window.attachEvent("onmessage",function(a){listenPlayer(a)});var waitingVideoIdForReady=[];var readyVideoIds=[];function listenPlayer(a){if(-1!=a.origin.indexOf("vcplayer.vcmedia.vn")||-1!=a.origin.indexOf("123.31.11.105")||-1!=a.origin.indexOf("vcplayer.mediacdn.vn")){if("object"==typeof a.data){if(typeof(a.data.method)!="undefined"){switch(a.data.method){case"currentTime":if(typeof(a.data.rid)==="object"){videoInContent.seekCurrentTime(a.data.rid.id,a.data.data)}else{videoInContent.setCurrentTime(a.data.rid,a.data.data)}break}}else{if(typeof(a.data.event)!="undefined"){switch(a.data.event){case"canplaythrough":$("#"+a.data.boxVideoID).parent().show();break}}else{if(typeof(a.data.action)!="undefined"){switch(a.data.action){case"ready":var c="#"+a.data.boxVideoID;readyVideoIds.push(c);if(waitingVideoIdForReady.length>0){if($.inArray(c,waitingVideoIdForReady)>=0){videoInContent.playVideo(c);waitingVideoIdForReady.splice($.inArray(c,waitingVideoIdForReady),1)}}break}}}}}}}if(!windowPrototype){var windowPrototype={wdHeight:function(){var b;"number"==typeof window.innerWidth?b=window.innerHeight:document.documentElement&&document.documentElement.clientHeight?b=document.documentElement.clientHeight:document.body&&document.body.clientHeight&&(b=document.body.clientHeight);return b},wdWidth:function(){var b;"number"==typeof window.innerWidth?b=window.innerWidth:document.documentElement&&document.documentElement.clientWidth?b=document.documentElement.clientWidth:document.body&&document.body.clientWidth&&(b=document.body.clientWidth);return b}},Browser={Version:function(){var b=999;-1!=navigator.appVersion.indexOf("MSIE")&&(b=parseFloat(navigator.appVersion.split("MSIE")[1]));return b}},browserVersion=Browser.Version(),admwdHeight=parseInt(windowPrototype.wdHeight())}if(typeof(getElementTop)=="undefined"){var getElementTop=function(b){if(document.getElementById){var a=document.getElementById(b)}else{if(document.all){var a=document.all[b]}}if(a!=null){yPos=a.offsetTop;tempEl=a.offsetParent;while(tempEl!=null){yPos+=tempEl.offsetTop;tempEl=tempEl.offsetParent}return yPos}else{return 0}}}function getScrollTop(){var a=document.body.scrollTop;if(a==0){if(window.pageYOffset){a=window.pageYOffset}else{a=(document.body.parentElement)?document.body.parentElement.scrollTop:0}}return a}var currentTimingVideo=null;function admPlayProgress(a){var b=3;var e=$(a);if(currentTimingVideo!=e&&currentTimingVideo!=null){currentTimingVideo.find(".bg-wraper").hide()}currentTimingVideo=e;var c=e.find('iframe[src*="vcplayer.vcmedia.vn"], iframe[src*="123.31.11.105"], iframe[src*="vcplayer.mediacdn.vn"]');if(e.find(".bg-wraper").length>0){e.find(".loading-vid-countdown").fadeIn(1500);e.find(".loading-vid-countdown").addClass("quickspin");e.find(".bg-wraper").addClass("bgPoster");if(detectmob()){setTimeout(function(){if($.inArray("#"+c.attr("id"),readyVideoIds)>=0){videoInContent.playVideo(c)}else{waitingVideoIdForReady.push("#"+c.attr("id"))}e.find(".bg-wraper").hide()},1000)}else{e.find(".lvc-label").show();e.find(".lvc-number").show();var d=setInterval(function(){if(b==2){if($.inArray("#"+c.attr("id"),readyVideoIds)>=0){videoInContent.playVideo(c)}else{waitingVideoIdForReady.push("#"+c.attr("id"))}}if(b>0){e.find(".lvc-number").html(b)}else{clearInterval(d);e.find(".bg-wraper").hide()}b=b-1},500)}}else{if($.inArray("#"+c.attr("id"),readyVideoIds)>=0){videoInContent.playVideo(c)}else{waitingVideoIdForReady.push("#"+c.attr("id"))}}}function getRandomeString(){return Math.random().toString(36).substr(2,9)}var videoInStream={isFullscreen:false,init:function(b){var a=this;var c="webkitfullscreenchange mozfullscreenchange fullscreenchange MSFullscreenChange";$(document).on(c,function(){a.changeIsFullscreen()});var d=$(b).find('iframe[src*="vcplayer.vcmedia.vn"], iframe[src*="123.31.11.105"], iframe[src*="vcplayer.mediacdn.vn"]');d.each(function(i,e){var j=$(this);var g=false,h=true;var f;$(window).scroll(function(n){if(f){window.clearTimeout(f);f=null}var l=$(window).scrollTop();var m=j.offset().top;var k=j.outerHeight();if(l>=m-k&&l<m){f=setTimeout(function(){if(!g&&!a.isFullscreen){videoInContent.playVideo(j);g=true}},0)}else{clearTimeout(f);setTimeout(function(){if((g||h)&&!a.isFullscreen){videoInContent.stopVideo(j);g=false;h=false}},0)}})})},changeIsFullscreen:function(){var a=this;a.isFullscreen=!a.isFullscreen}};function renderIframeLive(c,b){if(c&&c!=""){var d=$(b).width(),a=d*10/16;if(c.indexOf("?")!=-1){c+="&t="+new Date().getTime()}else{c+="?t="+new Date().getTime()}$(b).html('<iframe id="live-iframe" src="'+c+'" style="width:'+d+"px;height:"+a+'px;display:block;"frameborder="0" allowfullscreen scrolling="no"></iframe>')}};WebFont.load({custom:{families:["SFD-Bold"]}});function formatNewsType(){var a=$("a[rel*='type']");$.each(a,function(d,b){var e=$(b).attr("type");var c=$(b).attr("newsid");if(e==92){$(b).css("position","relative");$(b).append('<span class="iconwesend"></span>')}else{if(e==10){fotmatLiveType(b,c)}else{if(e==11){fotmatLiveSportType(b,c)}else{if(e==95){fotmatBigMagazine(b,c)}}}}})}function builtLinkMagazine(a){return"/magazine/"+a+".chn"}function returnFC(e){eval(e.data)}var CssUpdate={fancyActive:function(a){$.fancybox.close()}};function fotmatBigMagazine(a,b){if(window.addEventListener){window.addEventListener("message",function(c){returnFC(c)},false)}else{if(window.attachEvent){window.attachEvent("onmessage",function(c){returnFC(c)})}}$(a).addClass("fancybox.iframe");$(a).attr("href","javascript:;");$(a).attr("onclick","openMagazine(this,'"+b+"')")}function openMagazine(a,b){$.ajax({url:Constants.apiHandlerUrl+"/Handler/BigMagazine/GetData.ashx",data:({newsid:b,c:"getmagazineid"}),dataType:"json",type:"GET",success:function(c){if(c.Success){$(a).attr("href",builtLinkMagazine(c.Data.Value));$.fancybox.open($(a),{maxWidth:"100%",maxHeight:"100%",fitToView:true,width:"100%",height:"100%",autoSize:true,padding:0,margin:0,beforeShow:function(){$(".fancybox-wrap").addClass("popup-mag")},beforeClose:function(){$(".fancybox-wrap").addClass("popup-mag-close");$(a).fancybox({maxWidth:"100%",maxHeight:"100%",fitToView:true,width:"100%",height:"100%",autoSize:true,padding:0,margin:0,beforeShow:function(){$(".fancybox-wrap").addClass("popup-mag")},beforeClose:function(){$(".fancybox-wrap").addClass("popup-mag-close")},helpers:{overlay:{showEarly:false}},iframe:{scrolling:"auto",preload:false}})},helpers:{title:null,overlay:{showEarly:false}},iframe:{scrolling:"auto",preload:false}})}}})}function fotmatLiveSportType(a,b){$.ajax({url:Constants.apiLiveDomain+"/Handler/Detail/LiveSport.ashx",data:({newsid:b}),dataType:"json",type:"GET",success:function(c){if(c!=null&&c.Success){if(!c.Data.MatchFinished){$(a).addClass("livenews-type")}}}})}function fotmatLiveType(a,b){$.ajax({url:Constants.apiLiveDomain+"/Handler/Detail/Live.ashx",data:({c:"getall",newsid:b}),dataType:"json",type:"GET",success:function(c){if(c!=null&&c.Success){if(c.Data.Status==1){$(a).addClass("livenews-type")}}}})}function GetValue(){var e=$("#fDay").val();var c=$("#fMonth").val();if(e=="00"||c=="00"){alert("Bạn chưa chọn ngày tháng.");return false}var b=$("#fYear").val();var f=$("#CurrenTab").val();if(f!=null||f!=""){var d;window.location.href="/"+f+"/"+e+"-"+c+"-"+b+".chn"}return false}function UnicodeToKoDauAndGach(c){var a="abcdefghijklmnopqrstxyzuvxw0123456789 ";c=UnicodeToKoDau(c.toLowerCase());var d="";for(var b=0;b<c.length;b++){if(a.indexOf(c.charAt(b))>-1){if(c.charAt(b)!=" "){d+=c.charAt(b)}else{if(b>0&&c.charAt(b-1)!=" "&&c.charAt(b-1)!="-"){d+="-"}}}}return d}function UnicodeToKoDau(d){var c="àáảãạâầấẩẫậăằắẳẵặèéẻẽẹêềếểễệđìíỉĩịòóỏõọôồốổỗộơờớởỡợùúủũụưừứửữựỳýỷỹỵÀÁẢÃẠÂẦẤẨẪẬĂẰẮẲẴẶÈÉẺẼẸÊỀẾỂỄỆĐÌÍỈĨỊÒÓỎÕỌÔỒỐỔỖỘƠỜỚỞỠỢÙÚỦŨỤƯỪỨỬỮỰỲÝỶỸỴÂĂĐÔƠƯ";var f="aaaaaaaaaaaaaaaaaeeeeeeeeeeediiiiiooooooooooooooooouuuuuuuuuuuyyyyyAAAAAAAAAAAAAAAAAEEEEEEEEEEEDIIIOOOOOOOOOOOOOOOOOOOUUUUUUUUUUUYYYYYAADOOU";var e="",b=0;for(var a=0;a<d.length;a++){b=c.indexOf(d.charAt(a));if(b>=0){e+=f.charAt(b)}else{e+=d.charAt(a)}}return e}function SearchOnFocusHome(a){if(a.value=="Nhập nội dung tìm kiếm ..."){a.value=""}}function SearchOnBlurHome(a){if(a.value==""){a.value="Nhập nội dung tìm kiếm ..."}}function CheckValue(){var a;a=$("#searchinput").text();if(a==""||a=="Nhập nội dung tìm kiếm ..."){alert("Bạn chưa nhập từ khóa");return false}else{window.location=Constants.searchHost+"?query="+htmlEncode(a)}}function BBEnterPressSearch(b){var a;if(b&&b.which){b=b;a=b.which}else{b=window.event;a=b.keyCode}if(a==13){CheckValue();return false}return true}function getViewVideoOld(c){var d=Constants.apiHandlerUrl+"/Handler/Video/DataHandler.ashx";var e="";var a=0;var f=$(c).find(".need-get-view");f.each(function(g,h){if(a==0){e+=$(this).attr("data-key")}else{e+=","+$(this).attr("data-key")}a++});var b="Video_Tracking_Old";$.ajax({type:"GET",url:d,data:({videoKeys:e,method:b}),dataType:"json",success:function(g){try{$.each(g.Data,function(l,i){var j=$(c).find(".need-get-view[data-key='"+i.MediaKey+"']");if(i.play>0){var m=(i.play>=1000000)?"0.0a":"0,0a";var k=numeral(i.play).format(m).replace(",",".");j.html(k);j.show();j.removeClass("need-get-view")}j.removeClass("need-get-view")})}catch(h){}}})}function getViewVideoOld(c,g){if(typeof(g)=="undefined"){g=""}else{g=" "+g}var d=Constants.apiHandlerUrl+"/Handler/Video/DataHandler.ashx";var f="";var a=0;var e=$(c).find(".need-get-view");e.each(function(h,i){if(a==0){f+=$(this).attr("data-key")}else{f+=","+$(this).attr("data-key")}a++});var b="Video_Tracking_Old";$.ajax({type:"GET",url:d,data:({videoKeys:f,method:b}),dataType:"json",success:function(h){try{$.each(h.Data,function(m,j){var k=$(c).find(".need-get-view[data-key='"+j.MediaKey+"']");if(j.play>0){var n=(j.play>=1000000)?"0.0a":"0,0a";var l=numeral(j.play).format(n).replace(",",".");k.html(l+g);k.show();k.removeClass("need-get-view")}k.removeClass("need-get-view")})}catch(i){}}})}function getViewVideo(c){var d=Constants.apiHandlerUrl+"/Handler/Video/DataHandler.ashx";var e="";var a=0;var f=$(c).find(".need-get-view");f.each(function(g,h){if(a==0){e+=$(this).attr("data-key")}else{e+=","+$(this).attr("data-key")}a++});var b="Video_Tracking";$.ajax({type:"GET",url:d,data:({videoKeys:e,method:b}),dataType:"json",success:function(g){try{$.each(g.videos,function(l,i){var j=$(c).find(".need-get-view[data-key='"+i.key+"']");if(i.play>0){var m=(i.play>=1000000)?"0.0a":"0,0a";var k=numeral(i.play).format(m).replace(",",".");j.html(k);j.show();j.removeClass("need-get-view")}j.removeClass("need-get-view")})}catch(h){}}})}function getViewVideo(c,g){if(typeof(g)=="undefined"){g=""}else{g=" "+g}var d=Constants.apiHandlerUrl+"/Handler/Video/DataHandler.ashx";var f="";var a=0;var e=$(c).find(".need-get-view");e.each(function(h,i){if(a==0){f+=$(this).attr("data-key")}else{f+=","+$(this).attr("data-key")}a++});var b="Video_Tracking";$.ajax({type:"GET",url:d,data:({videoKeys:f,method:b}),dataType:"json",success:function(h){try{$.each(h.videos,function(m,j){var k=$(c).find(".need-get-view[data-key='"+j.key+"']");if(j.play>0){var n=(j.play>=1000000)?"0.0a":"0,0a";var l=numeral(j.play).format(n).replace(",",".");k.html(l+g);k.show();k.removeClass("need-get-view")}k.removeClass("need-get-view")})}catch(i){}}})}function getViewVideoByFilename(f,i,c,d){if(typeof(i)=="undefined"){i=""}else{i=" "+i}var a=Constants.apiHandlerUrl+"/Handler/Video/DataHandler.ashx";var e="";var b=0;var g=$(f).find(".need-get-view");g.each(function(j,k){if(b==0){e+=$(this).attr("rel")}else{e+=","+$(this).attr("rel")}b++});var h="Video_Tracking_ByFileName";$.ajax({type:"POST",url:a,async:false,data:({fileNames:e,method:h}),dataType:"json",success:function(j){try{$.each(j.videos,function(q,l){var n=$(f).find(".need-get-view[rel='"+l.key+"']");var m=l.play;if(m>0){var r=(m>=1000000)?"0.0a":"0,0a";var p=(d)?numeral(m).format(r).replace(",","."):numeral(m).format("0,0").replace(",",".");n.html(p+i);n.show();n.removeClass("need-get-view")}else{if(c){n.hide()}}n.removeClass("need-get-view")})}catch(k){}}})}function getCountComment(a){var b="";var c=0;$("span.item-comment").each(function(){var e=$(this);var d=e.attr("rel");if(c==0){b+=d}else{b+=","+d}c++;e.removeClass("item-comment");e.addClass("item-comment-loaded")});if(c<1){return}$.ajax({url:Constants.apiHandlerUrl+"/Handler/GetExtendParamSocial.ashx",data:({c:"mingcommentcountgetlist",from:a,lstsorturl:b}),dataType:"json",type:"POST",beforeSend:function(){},success:function(d){if(d!=null&&d.Success){var e=JSON.parse(d.Data);$.each(e,function(h,f){var g=$(".item-comment-loaded[rel*='"+f.SortUrl+"']");if(f.CntCm>0){g.html(f.CntCm);g.show()}})}}})}function getCountCommentNotAsync(c){var a=$(c);var d=a.attr("rel");var b=0;$.ajax({url:Constants.apiHandlerUrl+"/Handler/GetExtendParamSocial.ashx",data:({c:"mingcommentcountgetlist",from:c,lstsorturl:d}),dataType:"json",type:"POST",async:false,beforeSend:function(){},success:function(e){if(e!=null&&e.Success){var f=JSON.parse(e.Data);$.each(f,function(g,h){b=h.CntCm})}}});return b}function getFbDataByListUrl(){return;var a="";var b=0;$(".item-fb").each(function(){var c=($(this).attr("rel"));if(b==0){a+=Constants.host+c}else{a+=","+Constants.host+c}b++});if(b<1){return}$.ajax({type:"GET",dataType:"json",url:"https://sharefb.cnnd.vn/?urls="+a,success:function(c){$.each(c,function(g,d){var f=d.url.replace(Constants.host,"");var e=$(".item-fb[rel*='"+f+"']");if(d.total_count>0){e.html(d.total_count);e.show()}else{e.html("0 like");e.hide()}e.removeClass("item-fb");e.addClass("item-fb-loaded")})}})}function getFbDataByObj(f,d,e,c){var b="";var a=0;$(f).each(function(){var g=($(this).attr("rel"));if(a==0){b+=Constants.host+g}else{b+=","+Constants.host+g}a++});if(a<1){return}$.ajax({type:"GET",dataType:"json",url:"https://sharefb.cnnd.vn/?urls="+b,success:function(g){$.each(g,function(m,h){var l=h.url.replace(Constants.host,"");var k=$(f+"[rel*='"+l+"']");var j=0;switch(d){case"like":j=h.like_count;break;case"share":j=h.share_count;break;case"total":j=h.total_count;break}if(j>0){var n=(j>=1000000)?"0.0a":"0,0a";var i=(c)?numeral(j).format(n).replace(",","."):numeral(j).format("0,0").replace(",",".");k.html(i);k.show()}else{if(e){k.hide()}}k.addClass("item-fb-loaded")})}})}function getCountCommentLink(b,a){return;var c="";var d=0;$(".item-comment").each(function(){var e=($(this).attr("rel"));if(d==0){c+=e}else{c+=","+e}d++});if(d<1){return}$.ajax({url:Constants.apiHandlerUrl+"/Handler/GetExtendParamSocial.ashx",data:({c:"mingcommentcountgetlist",from:b,lstsorturl:c}),dataType:"json",type:"POST",beforeSend:function(){},success:function(e){if(b==".same-category-stream"){}if(e.Success){var f=JSON.parse(e.Data);$.each(f,function(i,g){var h=$(".item-comment[rel*='"+g.SortUrl+"']");if(g.CntCm>10){h.html(g.CntCm);h.show()}else{if(a){h.hide()}}h.removeClass("item-comment")})}}})}function getCountCommentLinkNotReturn(b,a){var c="";var d=0;$(".item-comment").each(function(){var e=($(this).attr("rel"));if(d==0){c+=e}else{c+=","+e}d++});if(d<1){return}$.ajax({url:Constants.apiHandlerUrl+"/Handler/GetExtendParamSocial.ashx",data:({c:"mingcommentcountgetlist",from:b,lstsorturl:c}),dataType:"json",type:"POST",beforeSend:function(){},success:function(e){if(e.Success){var f=JSON.parse(e.Data);$.each(f,function(i,g){var h=$(".item-comment[rel*='"+g.SortUrl+"']");if(g.CntCm>10){h.html(g.CntCm);h.show()}else{if(a){h.hide()}}h.removeClass("item-comment")})}}})}function getCountCommentMinValueToShow(c,a,b){var d="";var e=0;$("span.item-comment").each(function(){var f=($(this).attr("rel"));if(e==0){d+=f}else{d+=","+f}e++});if(e<1){return}$.ajax({url:Constants.apiHandlerUrl+"/Handler/GetExtendParamSocial.ashx",data:({c:"mingcommentcountgetlist",from:c,lstsorturl:d}),dataType:"json",type:"POST",beforeSend:function(){},success:function(f){if(f.Success){var g=JSON.parse(f.Data);$.each(g,function(j,h){var i=$(".item-comment[rel*='"+h.SortUrl+"']");if(h.CntCm>=a){i.html(h.CntCm);i.show()}else{i.parents(b).hide()}})}}})}function getCountFbLike(){return;var a="";var b=0;$('label[rel="fblikecount"]').each(function(){var c=($(this).attr("sorturl"));if(b==0){a+=c}else{a+=","+c}b++});if(b<1){return}$.ajax({url:Constants.apiHandlerUrl+"/Handler/GetExtendParamSocial.ashx",data:({c:"getlikebylinks",lsturl:a}),dataType:"json",type:"GET",beforeSend:function(){},success:function(c){if(c.Success){var d=JSON.parse(c.Data);$.each(d,function(e,f){$("label[sorturl*='"+f.SortUrl+"']").html(f.CntFb)})}}})}function getCountView(b){var a="";var c=0;$(".item-view").each(function(){var d=($(this).attr("rel"));if(c==0){a+=d}else{a+=";"+d}c++});if(c<1){return}$.ajax({url:Constants.apiHandlerUrl+"/Handler/GetExtendParamSocial.ashx",data:({c:"adtechviewcountgetlist",from:b,lstNewsIds:a}),dataType:"json",type:"GET",beforeSend:function(){},success:function(d){if(d.Success){var e=JSON.parse(d.Data);$.each(e,function(j,f){var h=$(".item-view[rel*='"+f.newsId+"']");var i=f.total_view;var k=(i>=1000000)?"0.0a":"0,0a";var g=numeral(i).format(k).replace(",",".");if(i>0){h.html(g);h.removeClass("item-view")}})}}})}function getCountViewNotFormat(b){var a="";var c=0;$(".item-view").each(function(){var d=($(this).attr("rel"));if(c==0){a+=d}else{a+=";"+d}c++});if(c<1){return}$.ajax({url:Constants.apiHandlerUrl+"/Handler/GetExtendParamSocial.ashx",data:({c:"adtechviewcountgetlist",from:b,lstNewsIds:a}),dataType:"json",type:"GET",beforeSend:function(){},success:function(d){if(d.Success){var e=JSON.parse(d.Data);$.each(e,function(h,f){var g=$(".item-view[rel*='"+f.newsId+"']");var j=f.total_view;var i=numeral(j).format("0,0").replace(",",".");if(j>0){g.html(i);g.removeClass("item-view")}})}}})}function getCountView(c,b){if(typeof(b)=="undefined"){b=""}else{b=" "+b}var a="";var d=0;$(".item-view").each(function(){var e=($(this).attr("rel"));if(d==0){a+=e}else{a+=";"+e}d++});if(d<1){return}$.ajax({url:Constants.apiHandlerUrl+"/Handler/GetExtendParamSocial.ashx",data:({c:"adtechviewcountgetlist",from:c,lstNewsIds:a}),dataType:"json",type:"GET",beforeSend:function(){},success:function(e){if(e.Success){var f=JSON.parse(e.Data);$.each(f,function(k,g){var i=$(".item-view[rel*='"+g.newsId+"']");var j=g.total_view;var l=(j>=1000000)?"0.0a":"0,0a";var h=numeral(j).format(l).replace(",",".");if(j>0){i.html(h+b);i.removeClass("item-view");i.show()}})}}})}String.format=function(c){if(typeof(c)=="undefined"){return c}if(arguments.length<=1){return c}var a=arguments.length-2;for(var b=0;b<=a;b++){c=c.replace(new RegExp("\\{"+b+"\\}","gi"),arguments[b+1])}return c};(function(a){a.fn.listSorter=function(f){var c=this;var e={order:"asc"};f=a.extend(e,f);var b=a("li",c).get();var d="";switch(f.order){case"asc":case"desc":break;default:return new Error("Invalid option")}return c.each(function(){if(f.order=="asc"){var k=b.sort(function(j,m){var n=a(j).text();var i=a(m).text();return n[0].toLowerCase()>i[0].toLowerCase()});for(var g=0;g<k.length;g++){d+="<li>"+a(k[g]).text()+"</li>"}a(c).html(d)}else{var l=b.sort(function(j,m){var n=a(j).text();var i=a(m).text();return n[0].toLowerCase()<i[0].toLowerCase()});for(var h=0;h<l.length;h++){d+="<li>"+a(l[h]).text()+"</li>"}a(c).html(d)}})}})(jQuery);function HomeSohaEmbed(){var sohaEmbed_K14_PlaceID="sohaembed",sohaEmbed_SourceDomain="https://sohas.cnnd.vn",sohaEmbed_Kenh14_utmSource="?utm_source=Kenh14&utm_medium=Kenh14Embed&utm_campaign=Kenh14BoxEmbed",sohaEmbed_Kenh14_headUtmSource="?utm_source=Kenh14&utm_medium=Head_Kenh14Embed&utm_campaign=Head_Kenh14BoxEmbed",sohaEmbed_K14=new function(){this.imageWidth=144,this.imageHeight=90,this.top=4,this.type=4,sohaEmbed_K14_bindData=function(data){if(data=eval("("+data+")"),null!=data&&data.length>0){var topItemFormat='<a href="{0}" target="_blank" class="klcbfn-thumb" title="{2}"><img src="{4}" /></a><div class="klcbfn-info"><h3 class="klcbfn-title"><a href="{0}" target="_blank" title="{2}">{1}</a></h3><p class="klcbfn-sapo">{3}</p></div>',otherFormat='<li class="klcb-news"><a title="{2}" target="_blank" href="{0}">{1}</a></li>',embedHtml="";embedHtml+='<h2 class="klcb-cat-name">',embedHtml+='<a href="http://soha.vn'+sohaEmbed_Kenh14_headUtmSource+'" target="_blank" title="tin tức">Tin hot từ Soha.vn</a>',embedHtml+="</h2>",embedHtml+='<div class="klcb-featured-news clearfix">';var item=data[0];embedHtml+=String.format(topItemFormat,item.AbsoluteURL+sohaEmbed_Kenh14_utmSource,item.Title,item.EncodedTitle,item.Sapo,item.EmbedImage),embedHtml+="</div>",embedHtml+='<ul class="list-klcb-news">';for(var i=1;i<data.length;i++){item=data[i],embedHtml+=String.format(otherFormat,item.AbsoluteURL+sohaEmbed_Kenh14_utmSource,item.Title,item.EncodedTitle)}embedHtml+="</ul>";$("#"+sohaEmbed_K14_PlaceID).html(embedHtml)}},this.sohaEmbed_K14_getData=function(){var e="/Services/GetEmbedData.ashx?Top={0}&ImageWidth={1}&ImageHeight={2}&Type={3}",t=sohaEmbed_SourceDomain+String.format(e,this.top,this.imageWidth,this.imageHeight,this.type);$.ajax({type:"GET",url:t,dataType:"jsonp",success:function(e){JSON.stringify(e.Success)&&sohaEmbed_K14_bindData(JSON.stringify(e.Data))}})}};sohaEmbed_K14.sohaEmbed_K14_getData()}function struncateString(a,b){$(a).each(function(){var c=$(this).html();if(c.length>b){c=(c.substr(0,b-3));$(this).html(c).append("...")}})}var brandContentStream={content:"",attr:"newsid",init:function(b){var a=this;a.content=$(b);var c="";var d=0;a.content.find(".knswli:not(.done-get-brand-content)").each(function(){var e=($(this).find(".knswli-title a").attr(a.attr));if(typeof(e)!="undefined"){if(d==0){c+=e}else{c+=","+e}d++;$(this).addClass("done-get-brand-content")}});if(d<2){console.log("brandContent: "+b+" "+c);return}$.ajax({url:Constants.apiHandlerUrl+"/Handler/RequestHandlers.ashx",data:{c:"newbrandcontentbynewsids",newsIds:"'"+c+"'"},dataType:"json",type:"GET",crossDomain:true,beforeSend:function(){},success:function(e){if(e!=null){a.genToolTip(e)}}})},genToolTip:function(a){var b=this;$.each(a,function(e,d){var c=b.content.find(".knswli .knswli-title a["+b.attr+"*='"+d.NewsId+"']").parents(".knswli");var f='<div class="brand-content stream k14topic-sapo">';f+=String.format('<a href="{0}" title="{1}" class="k14topic-logo">',d.BrandContentUrl,d.BrandContentName);f+=String.format('<img src="{0}" />',d.BrandContentLogoStream);f+="</a>";f+="</div>";c.find(".knswli-right").prepend(f);c.find(".klcbfn-subtitle").remove();c.find(".knswli-right .brand-content .k14topic-news-title a").trimLine(4);c.find(".knswli-right").find(".k14topic-sapo").hide().fadeIn(600);c.find(".knswli-right").find(".k14topic-sapo").css("display","inline-block")})},initNotApi:function(b){var a=this;a.content=$(b);var c=a.content.find(".knswli[data-brandId]:not(.done-get-brand-content)");a.genToolTipNotApi(c)},genToolTipNotApi:function(a){var b=this;$.each(a,function(d,c){var f=$(c);var e='<div class="brand-content stream k14topic-sapo">';e+=String.format('<a href="{0}" title="{1}" class="k14topic-logo">',f.attr("data-BrandUrl"),f.attr("data-BrandName"));e+=String.format('<img src="{0}" />',f.attr("data-LogoStream"));e+="</a>";e+="</div>";f.find(".knswli-right").prepend(e);f.find(".klcbfn-subtitle").remove();f.find(".knswli-right .brand-content .k14topic-news-title a").trimLine(4);f.find(".knswli-right").find(".k14topic-sapo").hide().fadeIn(600);f.find(".knswli-right").find(".k14topic-sapo").css("display","inline-block");f.addClass("done-get-brand-content")})}};function getTypeNews(a){var b="";switch(a.find(".knswli-title a").attr("type")){case"3":b="lb-image";addLabelType(a,b);break;case"2":b="lb-video";addLabelType(a,b);break;case"7":b="lb-image";addLabelType(a,b);b="lb-video";addLabelType(a,b);break}a.addClass("done-get-type")}function addLabelType(c,a){if(a!=""){var b='<span class="sprite '+a+'"></span>';c.find(".knswli-title a").append(b)}}function getStickerInNews(a){var b="";switch(a.find(".knswli-title a").attr("newstype")){case"1":b="sticker-hot";addSticker(a,b);break;case"2":b="sticker-musttry";addSticker(a,b);break;case"5":b="sticker-nong";addSticker(a,b);break;case"6":b="sticker-quy";addSticker(a,b);break;case"7":b="sticker-sock";addSticker(a,b);break;case"8":b="sticker-hong";addSticker(a,b);break;case"9":b="sticker-cute";addSticker(a,b);break}a.addClass("done-get-sticker")}function addSticker(c,b){if(b!=""){var a="<span class='sticker "+b+"'>";c.find(".knswli-left").append(a);c.find(".knswli-left").addClass("pos-rlt")}}function getLabelNews(){var a=$("a[rel*='init-sapo']");$.each(a,function(d,b){var e=$(b).attr("init-sapo-type");switch(e){case"1":addLabelLiveSportType(b);break;case"2":addLabelLiveType(b);break;case"3":addLabelEditorChoiceType(b);break;case"4":addLabelMonopolyType(b);break}$(b).addClass("pos-rlt");var c=$(b).attr("rel");$(b).attr("rel",c.replace("init-sapo",""))})}function addLabelLiveSportType(a){$(a).append('<div class="label-news label-live-sport"><span>TRỰC TIẾP</span></div>')}function addLabelLiveType(b){var a=$(b).attr("init-sapo-value");$(b).append('<div class="label-news label-live"><span>'+a+"</span></div>")}function addLabelEditorChoiceType(a){$(a).append('<div class="label-news label-editor-choice"><span>EDITOR</span><span>CHOICE</span></div>')}function addLabelMonopolyType(a){$(a).append('<div class="label-news label-monopoly"><span>ĐỘC QUYỀN</span></div>')}var trendingTag={init:function(){var b=this;var a=0;if(typeof(zoneid)!="undefined"){a=zoneid}$.ajax({url:Constants.apiHandlerUrl+"/Handler/RequestHandlers.ashx",data:{c:"trendingtag",zoneId:a},dataType:"json",type:"GET",crossDomain:true,beforeSend:function(){},success:function(c){if(c!=null){var d="";$.each(c,function(f,e){d+="<li class='khwtht'>";d+="        <a href='"+((e.Id+"")==""?e.Url:"/"+e.Url+".html")+"' title='"+e.Name+"'>#"+e.Name+"</a>";d+="</li>"});if(d!=""){$(".list-khwtht").html(d)}else{$(".list-khwtht").hide()}}else{$(".list-khwtht").hide()}}})},error:function(){$(".list-khwtht").hide()}};function loadJsAsync(b,d){var a=document.getElementsByTagName("head")[0];var c=document.createElement("script");c.type="text/javascript";c.async=true;if(typeof d=="function"){c.onreadystatechange=c.onload=function(){d()}}c.src=b;if($('head script[scr="'+b+'"]').length==0){a.appendChild(c)}}function checkRunInit(){if(typeof runinit!="undefined"&&runinit.length>=1){runinit[0]();var b=runinit.length;var c=[];for(var a=1;a<b;a++){c.push(runinit[a])}runinit=c}window.setTimeout(function(){checkRunInit()},100)}checkRunInit();var timerScroll;function checkLazyImages(d){if(timerScroll){clearTimeout(timerScroll)}if($("img.customlazy:not(.loaded)").length>0){var c=0,a=(d+screen.height),b=screen.height/2,e=null;$("img.customlazy:not(.loaded)").each(function(){e=$(this);if(e.attr("data-src")!=undefined){c=e.offset().top;if((c+this.clientHeight)>=d&&c<=a){e.attr("src",e.attr("data-src")).addClass("loaded")}else{if(!e.hasClass("preload")&&c>=(d-b)&&c<=(a+b)){var f=new Image();f.onload=function(){$("img[data-src='"+this.src+"']:not(.loaded)").attr("src",this.src).addClass("loaded")};f.src=e.attr("data-src");e.addClass("preload")}}}else{e.removeClass("lazy")}})}}function processScroll(){var c=$(window).scrollTop();if(typeof runOnScroll!="undefined"&&runOnScroll.length>=1){var b=runOnScroll.length;for(var a=0;a<b;a++){if(typeof runOnScroll[a]=="function"){runOnScroll[a](c)}}}checkLazyImages(c)}$(function(){setTimeout(function(){processScroll()},100);document.addEventListener("touchmove",processScroll,false);document.addEventListener("scroll",processScroll,false);var a=document.getElementById("searchinput");if(a!=null){if(a.addEventListener){a.addEventListener("paste",handlepaste,false)}else{a.attachEvent("onpaste",handlepaste)}}});function handlepaste(f){var c,d,a;var b=document.getElementById("searchinput");if(f&&f.clipboardData&&f.clipboardData.types&&f.clipboardData.getData){c=f.clipboardData.types;if(((c instanceof DOMStringList)&&c.contains("text/html"))||(c.indexOf&&c.indexOf("text/html")!==-1)){d=f.clipboardData.getData("text/html");processPaste(b,d);f.stopPropagation();f.preventDefault();return false}}a=document.createDocumentFragment();while(b.childNodes.length>0){a.appendChild(b.childNodes[0])}waitForPastedData(b,a);return true}function waitForPastedData(b,c){if(b.childNodes&&b.childNodes.length>0){var a=b.innerHTML;b.innerHTML="";b.appendChild(c);processPaste(b,a)}else{setTimeout(function(){waitForPastedData(b,c)},20)}}function processPaste(f,e){var d=document.getElementById("searchinput");var c=convertHtmlToText(e);console.log(c);var b=c.replace(/\s\s+/g," ");console.log(b);d.innerText=b;f.focus()}function convertHtmlToText(b){var a=""+b;a=a.replace(/&nbsp;/gi," ");a=a.replace(/&amp;/gi,"&");a=a.replace(/&quot;/gi,'"');a=a.replace(/&lt;/gi,"<");a=a.replace(/&gt;/gi,">");a=a.replace(/<br>/gi," ");a=a.replace(/<br\s\/>/gi," ");a=a.replace(/<br\/>/gi," ");a=a.replace(/<p.*>/gi," ");a=a.replace(/<a.*href="(.*?)".*>(.*?)<\/a>/gi," $2 ");a=a.replace(/<script.*>[\w\W]{1,}(.*?)[\w\W]{1,}<\/script>/gi," ");a=a.replace(/<script.*src\s*=\s*[\"']?([^\"']+)[\"']?[^\<>]/gi,"$1");a=a.replace(/<style.*>[\w\W]{1,}(.*?)[\w\W]{1,}<\/style>/gi," ");a=a.replace(/<style.*src\s*=\s*[\"']?([^\"']+)[\"']?[^\<>]/gi,"$1");a=a.replace(/<(?:.|\s)*?>/g," ");a=a.replace(/(?:(?:\r\n|\r|\n)\s*){2,}/gim," ");a=a.replace(/ +(?= )/g," ");a=a.replace(/</gi,"");a=a.replace(/>/gi,"");return a};var tag={pageSize:5,tagUrl:"",xhrTagRequest:null,init:function(){var a=this},doSelectCat:function(a){if($(a).hasClass("active")){$(a).removeClass("active").parent().removeClass("active")}else{$(a).addClass("active").parent().addClass("active")}var b="";$('.kbwcblwtntf-filter > li > a[class*="active"]').each(function(){b+='<li class="kbwcblwtntfs"><a href="javascript:void(0)" onclick="tag.unselectCat(this, \''+$(this).attr("rel")+"')\">"+$(this).html()+"</a></li>"});$(".list-kbwcblwtntfs").html(b);if(b===""){$(".kbwcblwtnt-filter-selected").addClass("hidden")}else{$(".kbwcblwtnt-filter-selected").removeClass("hidden")}this.doBindTagData(true,1)},unselectCat:function(a,b){$(a).parent().remove();$(".kbwcblwtntf-filter > li > a[rel="+b+"]").removeClass("active").parent().removeClass("active");if($(".list-kbwcblwtntfs").html()==""){$(".kbwcblwtnt-filter-selected").addClass("hidden")}this.doBindTagData(true,1)},unselectAllCat:function(){$(".list-kbwcblwtntfs").html("");$(".kbwcblwtnt-filter-selected").addClass("hidden");$('.kbwcblwtntf-filter > li > a[class*="active"]').each(function(){$(this).removeClass("active").parent().removeClass("active")});this.doBindTagData(true,1)},doBindTagData:function(b,d){var e=this;checkLoad=1;var c=$(".knsw-list li").last().prev();c.attr("style","border-bottom: none;");if(e.xhrTagRequest){e.xhrTagRequest.abort()}var a="";$('.kbwcblwtntf-filter > li > a[class*="active"]').each(function(){if(a==""){a=$(this).attr("rel")}else{a+="|"+$(this).attr("rel")}});if(b){$(".knsw-list").hide();$("#pnlLoading").show()}var f=true;e.xhrTagRequest=$.ajax({url:Constants.apiHandlerUrl+"/tag-news-per.chn",async:false,data:({tag_url:e.tagUrl,page:d,catids:a}),success:function(h){if(b){var i=$('.knsw-list .knswli[data-boxtype="NewsPublish"]');i.remove();var g=$("#lastPage").before(h);i=$('.knsw-list .knswli[data-boxtype="NewsPublish"]');var j=i.length>5?5:i.length-1;var l=$('.knsw-list .knswli[data-boxtype="NewsPublish"]')[j];$(l).after($("#ulTinNoiBat").parent());setTimeout(function(){$("#pnlLoading").hide();$(".knsw-list").show(200)},1000)}else{var g=$("#lastPage").before(h)}getSocial();$(".sapo-need-trim").each(function(){$(this).trimLine(3);$(this).removeClass("sapo-need-trim")});$(g).find("li").removeClass("fade-out");checkLoad=0;$("#IconLoadListDetail").hide();c.attr("style","border-bottom: 1px solid #ebebeb;");try{FB.XFBML.parse()}catch(k){}$(".bfthi").remove();try{$(h);f=true}catch(k){f=false}},error:function(){checkLoad=0;$("#IconLoadListDetail").hide();f=true}});return f}};var LightBoxType={Default:0,LiveSport:1,Cool:2,TransferMarket:3};var photoLightBox={arr:new Array(),arrFull:[],divElement:".content",imgSr:"https://kenh14cdn.com/",imgSr1:"http://channel.mediacdn.vn/",imgSr2:"https://kenh14cdn.com/",app_key:"d9c694bd04eb35d96f1d71a84141d075",width:0,height:0,photoWidth:0,flag:true,_admZone:1421,allowFullScreen:true,isLive:true,type:LightBoxType.Default,startItem:"",init:function(){var a=this;var b="";a.arrFull=[];a.arr=new Array();var c;var e;var d;if(a.type==LightBoxType.Cool){c=$(a.divElement).find('img[class*="photo-box1-img"]');d=$(a.divElement).find('a[class*="img-title"]')}else{c=$(a.divElement).find('img[src*="'+a.imgSr+'"], img[src*="'+a.imgSr1+'"], img[src*="'+a.imgSr2+'"]')}c.each(function(g){b+=String.format('<li><a href="javascript:void(0)"><img src="{0}" alt="" /></a></li>',$(this).attr("src"));var f={};f.title=$(this).attr("alt");f.sapo=$(this).attr("sapo");f.src=$(this).attr("src");f.link=$(this).attr("link");if($(this).attr("id")){f.id=$(this).attr("id")}else{f.id=0}f.isYoN=$(this).attr("isYoN");a.arrFull.push(f);a.arr.push($(this).attr("src"))});c.hover(function(){if(!$(this).parent().is('a[target="_blank"]')){$(this).css("cursor","pointer")}},function(){if(!$(this).parent().is('a[target="_blank"]')){$(this).css("cursor","none")}});c.on("click",function(){if(!$(this).parent().is("a")){a.openPopup();a.bindData($(this).attr("src"))}});if(a.type==LightBoxType.Cool){d.on("click",function(){var f=$(this).parent().parent().parent().find("img").attr("src");a.openPopup();a.bindData(f)})}if(a.arr.length>5){$(".popup-slide ul").html(b);$(".popup-slide").show()}if(window.location.hash!=""){if(window.location.hash.split("#")[1].indexOf("lb")!=-1){lb=window.location.hash.split("#")[1].replace("lb","");if($(a.divElement).find('img[lb="'+lb+'"]')!=null){a.openPopup();a.bindData($(a.divElement).find('img[lb="'+lb+'"]').attr("src"))}}}$(".popup-detail-content > img").hover(function(){$(this).css("cursor","pointer")});$(".popup-slide ul li").hover(function(){$(this).css("opacity","1")},function(){$(this).css("opacity","0.3")});$("#popup-detail-left").hover(function(){if(a.isZoom()||!a.flag){$(".popup-detail-content .zoom").fadeIn()}else{$(".popup-detail-content .zoom").hide()}if($.inArray($(".popup-slide li.active img").attr("src"),a.arr)==0){if(a.arr.length==1){return}$(".popup-detail-content .next").show()}else{if($.inArray($(".popup-slide li.active img").attr("src"),a.arr)==a.arr.length-1){$(".popup-detail-content .prev").show()}else{$(".popup-detail-content .prev, .popup-detail-content .next").fadeIn()}}},function(){$("#popup-detail-left .zoom").hide();$(".popup-detail-content .prev, .popup-detail-content .next").hide()});if(a.startItem!=""){a.openPopup();a.bindData(a.startItem);a.startItem=""}},bindData:function(g){var f=this;f.reset();$(window).resize(function(){f.resize(f.width,f.height)});$(".popup-detail-content .prev, .popup-detail-content .next").hide();$("#popup-detail-bg").scrollTop(0);$(".popup-detail-content li").removeClass("active");if($.inArray(g,f.arr)==0){$(".popup-detail-content .next").show()}else{if($.inArray(g,f.arr)==f.arr.length-1){$(".popup-detail-content .prev").show()}else{$(".popup-detail-content .prev, .popup-detail-content .next").fadeIn()}}next="";prev="";var b=0;var c=0;var e="";var a={};for(i=0;i<f.arr.length;i++){if(f.arr[i]==g){next=f.arr[i+1];prev=f.arr[i-1];a=f.arrFull[i];break}}var d=g.replace(/thumb_w\/([0-9]+)\//,"").replace(/thumb_in\/[0-9]+_[0-9]+\//,"").replace(/zoom\/[0-9]+_[0-9]+\//,"");if(f.isLive){var h=new Image();h.onload=function(){f.width=b=h.width;f.height=c=h.height;f.resize(b,c);f.callBack(next,prev)};h.src=d}else{if($(f.divElement).find('img[src="'+g+'"]').attr("w")!=null){b=$(f.divElement).find('img[src="'+g+'"]').attr("w")}else{b=$(f.divElement).find('img[src="'+g+'"]').width()}if($(f.divElement).find('img[src="'+g+'"]').attr("h")!=null){c=$(f.divElement).find('img[src="'+g+'"]').attr("h")}else{c=$(f.divElement).find('img[src="'+g+'"]').height()}f.width=b;f.height=c;f.resize(b,c);f.callBack(next,prev)}if($(f.divElement).find('img[src="'+g+'"]').attr("lb")!=null){e=encodeURIComponent("#lb"+$(f.divElement).find('img[src="'+g+'"]').attr("lb"))}$(".popup-detail-content > img").hide().attr("src",d).delay(800).fadeIn();if(a.title!=null){photoDetail.title=a.title;photoDetail.sapo="";$(".popup-detail-right-top h5").html(a.title)}if(a.sapo!=null){}if(a.isYoN==1){$(".popup-detail-right-top h5").css("color","#000");$.ajax({url:Constants.apiHandlerUrl+"/Handler/Fashion/YoN/Vote.ashx?m=getlikeanddislike&id="+a.id,xhrFields:{withCredentials:true},dataType:"json",success:function(k){if(k!=null){var m=JSON.parse(k.Data);var n=$(".popup-detail-right-top #lightbox_like");var j=$(".popup-detail-right-top #lightbox_dislike");$(".popup-detail-right-top .likeCnt").html(m[0].Like);$(".popup-detail-right-top .dislikeCnt").html(m[0].Dislike);$(n).attr("rel",m[0].IdNews);$(j).attr("rel",m[0].IdNews);if(m[0].IsLike==1){f.activeLike(n,j)}else{if(m[0].IsDislike==1){f.activeDislike(n,j)}else{f.deactiveAll(n,j)}}var l=$(".popup-detail-right-top .LightboxYoN_total").width();if((m[0].Like+m[0].Dislike)==0){$(".popup-detail-right-top .LightboxYoN_likeW").css("width",l/2)}else{$(".popup-detail-right-top .LightboxYoN_likeW").css("width",(l*m[0].Like)/(m[0].Like+m[0].Dislike))}}}})}if(f.allowFullScreen&&f.isZoom()){f.resizeFullScreen(b,c);$(".popup-detail-content .zoom").fadeIn();f.flag=false}if(f.isZoom()||!this.flag){$(".popup-detail-content .zoom").fadeIn()}else{$(".popup-detail-content .zoom").hide()}},activeLike:function(b,a){b.removeClass("likeLightboxYoN");b.addClass("likedLightboxYoN");b.attr("onclick","");a.removeClass("dislikedLightboxYoN");a.addClass("dislikeLightboxYoN");a.attr("onclick","doLikeOrDislike(this, 0, 2)")},activeDislike:function(b,a){a.removeClass("dislikeLightboxYoN");a.addClass("dislikedLightboxYoN");a.attr("onclick","");b.removeClass("likedLightboxYoN");b.addClass("likeLightboxYoN");b.attr("onclick","doLikeOrDislike(this, 1, 2)")},deactiveAll:function(b,a){b.removeClass("likedLightboxYoN");b.addClass("likeLightboxYoN");b.attr("onclick","doLikeOrDislike(this, 1, 2)");a.removeClass("dislikedLightboxYoN");a.addClass("dislikeLightboxYoN");a.attr("onclick","doLikeOrDislike(this, 0, 2)")},openPopup:function(){if(typeof(admDrawIframe)==="function"){admDrawIframe()}$("#popup-detail-bg").fadeIn("slow");$("body").addClass("no-scroll");$("#scroll_top").hide();$(document).keyup(this.keyUp)},closePopup:function(){$("#popup-detail-bg").fadeOut("slow");$("body").removeClass("no-scroll");$(document).off("keyup")},resize:function(v,t){var g=320;var e=320;var a=700;var r=400;var l=90;var q=70;var d=window.innerWidth-100;var u=window.innerHeight-75;d=(d<a)?a:d;u=(u<r)?r:u;var m=320;var o=15;var b=30;var s=d-$("#popup-detail-right").innerWidth();s=(s<e)?e:s;var k=s;if(v<=s){k=v}else{k=s}var f=parseInt(k*t/v);if(f>u){f=u-l;k=parseInt(v*f/t)}if(k<g){k=g;f=parseInt(k*t/v)}while(f>u){k=k-10;f=parseInt(k*t/v)}$("#popup-detail-wrap").css({width:d});$("#popup-detail-left .move").hide();$("#popup-detail-left, .popup-detail-content").css("width",s);if($("#popup-detail-left ul").html()!=""){$("#popup-detail-left, .popup-detail-content").css("height",u-q)}else{$("#popup-detail-left, .popup-detail-content").css("height",u)}$("#popup-detail-left .move").hide();$("#popup-detail-right").css("height",u);var j=document.documentElement.clientWidth;var h=document.documentElement.clientHeight;var n=$("#popup-detail-wrap").width();var c=$("#popup-detail-wrap").height();_left=(j/2-n/2-10)>0?j/2-n/2-10:0;$("#popup-detail-wrap").css({left:_left});this.flag=true;$(".popup-detail-content > img").attr("width",k).attr("height",f)},callBack:function(b,a){var c=this;$("#popup-detail-left .next, .popup-detail-content > img").off("click").on("click",function(){if(b!=null){c.bindData(b)}else{return false}});$("#popup-detail-left .prev").off("click").on("click",function(){if(a!=null){c.bindData(a)}else{return false}});$("#popup-detail-left .zoom").off("click").on("click",function(){if(c.isZoom()&&c.flag){c.flag=false;c.resizeFullScreen(c.width,c.height)}else{$("#popup-detail-left .move").hide();$(".popup-detail-right-box").css({position:"relative",left:"0",top:"0"});$("#popup-detail-bg").off("scroll");$(".popup-detail-content .next").css({position:"absolute",right:"30px"});$(".popup-detail-content .prev").css({position:"absolute",left:"30px"});c.flag=true;c.resize(c.width,c.height)}$(".popup-detail-content .zoom").css({position:"absolute",right:"20px"})});$(".move").off("click").on("click",function(){var d=$("#popup-detail-bg").scrollTop();$("#popup-detail-bg").animate({scrollTop:d+150},"slow")});$(".popup-slide  ul li a img").off("click").on("click",function(){if($(this).parent().parent("li").hasClass("active")){return}c.bindData($(this).attr("src"))});$("#popup-detail-wrap").click(function(){return false});$("#popup-detail-bg").click(function(){c.closePopup()})},keyUp:function(a){a.preventDefault();if(a.keyCode==27){photoDetail.closePopup()}if(a.keyCode==37){$("#popup-detail-left .prev").click()}if(a.keyCode==39){$("#popup-detail-left .next").click()}},resizeFullScreen:function(c,e){var g=70;var k=$("#popup-detail-right").innerWidth()+$("#popup-detail-wrap").position().left+45+"px";var d=$("#popup-detail-wrap").position().left+30+"px";$("#popup-detail-bg").scrollTop(0);if(c>$("#popup-detail-left").width()){$(".popup-detail-content > img").attr({width:$("#popup-detail-left").width(),height:Math.round($("#popup-detail-left").width()*e/c)})}else{$(".popup-detail-content > img").attr({width:c,height:e})}$("#popup-detail-left").css("height","auto");$(".popup-detail-content .next").css({position:"fixed",right:k});$(".popup-detail-content .prev").css({position:"fixed",left:d});if($("#popup-detail-left ul").html()!=""){if(this.allowFullScreen){$("#popup-detail-right").css("height",$(".popup-detail-content > img").height()+g)}else{$("#popup-detail-right").css("height",$("#popup-detail-left").height()+g)}}else{$("#popup-detail-left, .popup-detail-content").css("height",h);if(this.allowFullScreen){$("#popup-detail-right").css("height",$(".popup-detail-content > img").height())}else{$("#popup-detail-right").css("height",$(".popup-detail-content").height())}}var j=window.innerWidth-100;var h=window.innerHeight-75;var a=15;var b=document.documentElement.clientWidth;var l=$("#popup-detail-wrap").width();var f=$("#popup-detail-left").width()+(b/2-l/2-10)+a;$("#popup-detail-left .move").show();$("#popup-detail-bg").scroll(function(){var m=$(this).scrollTop();if(m>35){$(".popup-detail-right-box").css({position:"fixed",left:f,top:"0",height:h+40});$("#popup-detail-left .move").hide();$(".popup-detail-content .zoom").css({position:"fixed",right:$("#popup-detail-right").innerWidth()+$("#popup-detail-wrap").position().left+40+"px"})}else{$(".popup-detail-right-box").css({position:"relative",left:"0",top:"0"});$(".popup-detail-content .zoom").css({position:"absolute",right:"20px"})}})},isZoom:function(){zoom=false;if((parseInt($(".popup-detail-content > img").attr("width"),10)<parseInt(this.width,10)&&parseInt($(".popup-detail-content > img").attr("width"),10)<parseInt($("#popup-detail-left").width(),10))||!this.flag){zoom=true}return zoom},album_load:function(l){var j=this;var c=0;var m=50;var h=[];var a=8;var b=0;var k=$.inArray(l,j.arr);var g=0;var d=k+1;j.photoWidth=$("#popup-detail-left").width();$('.popup-slide li img[src="'+l+'"]').parent().parent().addClass("active");if(j.arr.length>5){if($(".popup-slide ul").html()!=""){for(f=0;f<j.arr.length;f++){h=j.getImgSize(j.arr[f]).split("|");if(f>0){c=c+a}c+=parseInt(h[0]*m/h[1]);if(c>j.photoWidth){continue}g=f+1}if(j.photoWidth<c+(g*a)){$(".popup-slide li").css("float","left").parent().css("width","5000px");if(d<=5){$(".popup-slide ul").animate({left:"0"},500)}else{if(j.arr.length-k<=5&&j.arr.length>10){return}for(var f=0;f<d-5;f++){b+=$('.popup-slide li img[src="'+j.arr[f]+'"]').parent().parent().outerWidth()}var e=b+($(".popup-slide ul").position().left-10);$(".popup-slide ul").animate({left:"-="+e},500)}}}}},getImgSize:function(a){var b=new Image();b.src=a;p=$(b).ready(function(){return{width:b.width,height:b.height}});return p[0]["width"]+"|"+p[0]["height"]},adBoxHeight:function(){var a=0;box=160;if(parseInt($("#popup-detail-right").height())>768){a=$("#popup-detail-right").height()-$(".popup-detail-right-top").innerHeight()-box*2}else{a=$("#popup-detail-right").height()-$(".popup-detail-right-top").innerHeight()-box}return a},showRightPanelScroll:function(){try{if($(".popup-detail-right-box").children(":first").css("top").indexOf("-")!=-1){$(".popup-detail-right-box").children(":first").css({top:0})}$(".popup-detail-right-box").slimScroll({railVisible:true,railOpacity:0.4,largeSize:"11px",height:1553})}catch(a){}},reset:function(){$("#popup-detail-left .move").hide();$(".popup-detail-content .popup-slide").hide();$(".popup-slide li").removeClass("active");$(".popup-detail-right-box").css({position:"relative",left:"0",top:"0"});$("#popup-detail-bg").off("scroll");$(".popup-detail-content .next").css({position:"absolute",right:"30px"});$(".popup-detail-content .prev").css({position:"absolute",left:"30px"});this.flag=true}};var prNews={divhomeFocus:"ul.list-klwfnswn",divListFocus:".klw-top-news",divList:"ul.knsw-list",divListTieuDiemTuan:"ul.knswli-object-list",divDuLichFocus:"ul.tsn-list-top-news",divDuLichList:"ul.tsn-list-news",divDuLichKenh14Choice:"#kenh14Choice-all",divDuLichAnCaTheGioi:"#quanxa-all",homeFocus:function(){var b=this;var a=$(b.divhomeFocus).find("li.prM13").attr("lc");if(a==0||a==LC){$(b.divhomeFocus).find(">li.prM13").removeAttr("style");$("ul.list-klwfnswn li:eq(2)").after($("ul.list-klwfnswn li:eq(0)"))}else{$(b.divhomeFocus).find(">li.prM13").remove()}},homeCategory:function(){$(".klw-category-news .klwcn-grid").not(".type6").each(function(){var j=$(this);if(j.find(".klwcng-left").length>1){var i=j.find(".klwcng-left.prM1").attr("lc");if(i==0||i==LC){j.find(".klwcng-left:first").attr("style","display:none !important");j.find(".klwcng-left.prM1").removeAttr("style");var a=j.find(".klwcng-left:first h3 > a").attr("href");var d=j.find(".klwcng-left:first h3 > a").text();var h=j.find(".klwcng-left:first h3 > a").attr("title");j.find('ul.list-klwcngrn li a[href="'+a+'"]').parents("li").remove();if(a!=j.find(".klwcng-left.prM1 h3 > a").attr("href")){var e='<li class="klwcngrn clearfix"><h4 class="klwcngrn-title"><a href="{0}" title="{1}">{2}</a></h4></li>';j.find("ul.list-klwcngrn li:eq(0)").before(String.format(e,a,h,d))}if(j.find("ul.list-klwcngrn li").length>2){j.find("ul.list-klwcngrn li:last").remove()}j.find("ul.list-klwcngrn li h4 a").trimLine(2)}else{j.find(".klwcng-left.prM1").remove()}}if(j.find(".klwcng-left").length>1){var f=j.find(".klwcng-left.prM104").attr("lc");if(f==0||f==LC){j.find(".klwcng-left:first").attr("style","display:none !important");j.find(".klwcng-left.prM104").removeAttr("style");var a=j.find(".klwcng-left:first h3 > a").attr("href");var d=j.find(".klwcng-left:first h3 > a").text();var h=j.find(".klwcng-left:first h3 > a").attr("title");j.find('ul.list-klwcngrn li a[href="'+a+'"]').parents("li").remove();if(a!=j.find(".klwcng-left.prM104 h3 > a").attr("href")){var e='<li class="klwcngrn clearfix"><h4 class="klwcngrn-title"><a href="{0}" title="{1}">{2}</a></h4></li>';j.find("ul.list-klwcngrn li:eq(0)").before(String.format(e,a,h,d))}if(j.find("ul.list-klwcngrn li").length>2){j.find("ul.list-klwcngrn li:last").remove()}j.find("ul.list-klwcngrn li h4 a").trimLine(2)}else{j.find(".klwcng-left.prM104").remove()}}if(j.find("ul.list-klwcngrn li").length>=2){var b=j.find("ul.list-klwcngrn li.prM2");var g=b.attr("lc");if(g==0||g==LC){var c=j.find("ul.list-klwcngrn li.prM2 a").attr("href");j.find('ul.list-klwcngrn li:not(".prM2") a[href="'+c+'"]').parents("li").remove();b.removeAttr("style");if(j.find("ul.list-klwcngrn li").length>2){j.find("ul.list-klwcngrn li:last").remove()}}else{b.remove()}}});$(".klw-category-news .klwcn-grid.type6").each(function(){var j=$(this);if(j.find("ul.list-klwcngrn .klwcngrn-thumb").length>1){var i=j.find("ul.list-klwcngrn li.prM1").attr("lc");if(i==0||i==LC){j.find("ul.list-klwcngrn li.prM1").removeAttr("style");var a=j.find("ul.list-klwcngrn li:first h4 > a").attr("href");var d=j.find("ul.list-klwcngrn li:first h4 > a").text();var h=j.find("ul.list-klwcngrn li:first h4 > a").attr("title");j.find("ul.list-klwcngrn li:first").remove();if(a!=j.find(".ul.list-klwcngrn li.prM1 h4 > a").attr("href")){var e='<li class="klwcngrn clearfix"><h4 class="klwcngrn-title"><a href="{0}" title="{1}">{2}</a></h4></li>';j.find("ul.list-klwcngrn li:eq(0)").after(String.format(e,a,h,d))}if(j.find("ul.list-klwcngrn li").length>3){j.find("ul.list-klwcngrn li:last").remove()}j.find("ul.list-klwcngrn li h4 a").trimLine(3)}else{j.find("ul.list-klwcngrn li.prM1").remove()}}if(j.find("ul.list-klwcngrn .klwcngrn-thumb").length>1){var f=j.find("ul.list-klwcngrn li.prM104").attr("lc");if(f==0||f==LC){j.find("ul.list-klwcngrn li.prM104").removeAttr("style");var a=j.find("ul.list-klwcngrn li:first h4 > a").attr("href");var d=j.find("ul.list-klwcngrn li:first h4 > a").text();var h=j.find("ul.list-klwcngrn li:first h4 > a").attr("title");j.find("ul.list-klwcngrn li:first").remove();if(a!=j.find(".ul.list-klwcngrn li.prM104 h4 > a").attr("href")){var e='<li class="klwcngrn clearfix"><h4 class="klwcngrn-title"><a href="{0}" title="{1}">{2}</a></h4></li>';j.find("ul.list-klwcngrn li:eq(0)").after(String.format(e,a,h,d))}if(j.find("ul.list-klwcngrn li").length>3){j.find("ul.list-klwcngrn li:last").remove()}j.find("ul.list-klwcngrn li h4 a").trimLine(3)}else{j.find("ul.list-klwcngrn li.prM104").remove()}}if(j.find("ul.list-klwcngrn li").length>=3){var b=j.find("ul.list-klwcngrn li.prM2");var g=b.attr("lc");if(g==0||g==LC){var c=j.find("ul.list-klwcngrn li.prM2 a").attr("href");j.find('ul.list-klwcngrn li:not(".prM2") a[href="'+c+'"]').parents("li").remove();b.removeAttr("style");if(j.find("ul.list-klwcngrn li").length>3){j.find("ul.list-klwcngrn li:last").remove()}}else{b.remove()}}})},listFocus:function(){return;var d=this;if($(d.divListFocus).find(".ktncli.prM13").length>0){var a=$(d.divListFocus).find(".ktncli.prM13").attr("lc");if(a==0||a==LC){$(d.divListFocus).find(".ktncli.prM13").removeAttr("style");if($(d.divListFocus).find(".ktncli").length>3){var f=$(d.divListFocus).find(".ktncli:visible:last");f.hide()}}else{$(d.divListFocus).find(".ktncli.prM13").remove()}}if($(d.divListFocus).find(".ktncli.prM104").length>0){var c=$(d.divListFocus).find(".ktncli.prM104").attr("lc");if(c==0||c==LC){$(d.divListFocus).find(".ktncli.prM104").removeAttr("style");var b=$(d.divListFocus).find(".ktncli.prM104 h3 > a").attr("href");$(d.divListFocus).find(".ktncli").not(".prM104").find('h3 > a[href="'+b+'"]').parents("li").remove();if($(d.divListFocus).find(".ktncli").length>3){var f=$(d.divListFocus).find(".ktncli:visible:last");f.hide()}}else{$(d.divListFocus).find(".ktncli.prM104").remove()}}if($(d.divListFocus).find(".ktncli.prM1").length>0){var e=$(d.divListFocus).find(".ktncli.prM1").attr("lc");if(e==0||e==LC){$(d.divListFocus).find(".ktncli:not([class*=prM]):first").after($(d.divListFocus).find(".ktncli.prM1"));$(d.divListFocus).find(".ktncli.prM1").removeAttr("style");if($(d.divListFocus).find(".ktncli").length>3){var f=$(d.divListFocus).find(".ktncli:visible:last");f.hide()}}else{$(d.divListFocus).find(".ktncli.prM1").remove()}}},list:function(){return;var a=this;$(a.divList).find(">li[class*=prM]").each(function(){var s=$(this).attr("lc");if(s==0||s==LC){var t=$(this).find(".knswli-title > a").attr("href");$(a.divList).find('>li:not([class*=prM]) .knswli-title > a[href="'+t+'"]').parents("li").remove();$(this).removeAttr("style")}else{$(this).remove()}});if($(a.divListFocus).find(".ktncli.prM13").length>0){var l=$(a.divListFocus).find(".ktncli.prM13").attr("lc");if(l==0||l==LC){var e=$(".ktncli:not(:visible):last");var d=e.find(" h3 > a").attr("href");var r=e.find(" h3 > a").attr("title");var k=e.find(" .ktncli-ava > img").attr("src");var b=e.find(" h3 > a").attr("rel");var q=e.find(" h3 > a").attr("data-id");var j=e.find(" h3 > a").text();var i=e.find(" .ktncli-sapo").text();var p=e.find(" .kscndsl-meta .kscliw-time").attr("title");var h=$(a.divList).find("li:first .knswli-category").attr("href");var o=$(a.divList).find("li:first .knswli-category").text();a.listAppend(0,d,k,j,o,p,i,q,b,r);e.remove()}var c=$(a.divListFocus).find(".ktncli.prM13 a").attr("href");a.removeList(c)}if($(a.divListFocus).find(".ktncli.prM1").length>0){var n=$(a.divListFocus).find(".ktncli.prM1").attr("lc");if(n==0||n==LC){var e=$(".ktncli:not(:visible):last");var d=e.find(" h3 > a").attr("href");var r=e.find(" h3 > a").attr("title");var k=e.find(" .ktncli-ava > img").attr("src");var b=e.find(" h3 > a").attr("rel");var q=e.find(" h3 > a").attr("data-id");var j=e.find(" h3 > a").text();var i=e.find(" .ktncli-sapo").text();var p=e.find(" .kscndsl-meta .kscliw-time").attr("title");var h=$(a.divList).find("li:first .knswli-category").attr("href");var o=$(a.divList).find("li:first .knswli-category").text();a.listAppend(0,d,k,j,o,p,i,q,b,r);e.remove()}var m=$(a.divListFocus).find(".ktncli.prM1 a").attr("href");a.removeList(m)}if($(a.divListFocus).find(".ktncli.prM104").length>0){var g=$(a.divListFocus).find(".ktncli.prM104").attr("lc");if(g==0||g==LC){var e=$(".ktncli:not(:visible):last");var d=e.find(" h3 > a").attr("href");var r=e.find(" h3 > a").attr("title");var k=e.find(" .ktncli-ava > img").attr("src");var b=e.find(" h3 > a").attr("rel");var q=e.find(" h3 > a").attr("data-id");var j=e.find(" h3 > a").text();var i=e.find(" .ktncli-sapo").text();var p=e.find(" .kscndsl-meta .kscliw-time").attr("title");var h=$(a.divList).find("li:first .knswli-category").attr("href");var o=$(a.divList).find("li:first .knswli-category").text();a.listAppend(0,d,k,j,o,p,i,q,b,r);e.remove()}var m=$(a.divListFocus).find(".ktncli.prM104 a").attr("href");a.removeList(m)}if($(".klw-fashion-topnews").find(".klwft-left.prM13").length>0){var l=$(".klw-fashion-topnews").find(".klwft-left.prM13").attr("lc");if(l==0||l==LC){$(".klw-fashion-topnews").find(".klwft-left.prM13").removeAttr("style");var e=$(".klwft-left").first();if(e.length>0){e.remove()}}var c=$(".klw-fashion-topnews").find(".klwft-left.prM13 a").attr("href");a.removeList(c)}if($(".klw-fashion-topnews").find(".klwft-left.prM104").length>0){var g=$(".klw-fashion-topnews").find(".klwft-left.prM104").attr("lc");if(g==0||g==LC){$(".klw-fashion-topnews").find(".klwft-left.prM104").removeAttr("style");var e=$(".klwft-left").first();if(e.length>0){e.remove()}}var f=$(".klw-fashion-topnews").find(".klwft-left.prM104 a").attr("href");a.removeList(f)}if($(".klw-fashion-topnews").find(".klwftr-topnews.prM1").length>0){var n=$(".klw-fashion-topnews").find(".klwftr-topnews.prM1").attr("lc");if(n==0||n==LC){var e=$(".klwftrn:not(:visible):last");if(e.length>0){var d=e.find(" h2 > a").attr("href");var r=e.find(" h2 > a").attr("title");var k=e.find(".klwftrn-thumb").text();var b=e.find(" h2 > a").attr("rel");var q=e.find(" h2 > a").attr("data-id");var j=e.find(" h2 > a").text();var i=e.find(" .klwftrn-sapo").text();var p=e.find(" .kscliw-time").attr("title");var h=$(a.divList).find("li:first .knswli-category").attr("href");var o=$(a.divList).find("li:first .knswli-category").text();a.listAppend(0,d,k,j,o,p,i,q,b,r);e.remove()}}var m=$(".klw-fashion-topnews").find(".klwftr-topnews.prM1 a").attr("href");a.removeList(m)}},listTieuDiemTuan:function(){var b=this;var a=$(b.divListTieuDiemTuan).find("li.prM500").attr("lc");if(a==0||a==LC){$(b.divListTieuDiemTuan).find(">li.prM500").removeAttr("style");$(b.divListTieuDiemTuan).find("li:eq(1)").after($(b.divListTieuDiemTuan).find("li:eq(0)"))}else{$(b.divListTieuDiemTuan).find(">li.prM500").remove()}},focusFashion:function(){return;var h=this;var j=$(".klw-fashion-topnews");if(j.find(".prM13").length>0){var a=j.find(".prM13").attr("lc");if(a==0||a==LC){j.find(".klwft-left:first").attr("style","display:none !important");j.find(".klwft-left.prM13").removeAttr("style");var b=j.find(".klwft-left:first > a").attr("href").trim();var c=j.find(".klwft-left:first .klwftlf-title").text().trim();var i=j.find(".klwft-left:first > a").attr("title").trim();var g=j.find(".klwft-left:first .klwftlf-thumb").text().trim();var k=j.find(".klwft-left:first .klwftlf-sapo").text().trim();if(b!=j.find(".klwft-left.prM13 h2 > a").attr("href")){var d="<div class='klwftr-topnews'><a href='{0}' title='{1}' class='klwftrt-thumb'><img src='{2}' alt='{1}'> </a> <h2 class='klwftrt-title'> <a href='{0}' title='{1}'>{3}</a> <p class='klwftrt-sapo'>{4}</p> </h2> </div>";j.find(".klwft-right .klwftr-topnews").after(String.format(d,b,i,g,c,k));if(j.find("ul.klwftr-news li").length>2){j.find("ul.klwftr-news li:last").remove()}b=j.find(".klwftr-topnews:first > a").attr("href").trim();c=j.find(".klwftr-topnews:first .klwftrt-title a").text().trim();i=j.find(".klwftr-topnews:first > a").attr("title").trim();j.find(".klwftr-topnews:first").hide();var f="<li class='klwftrn'><h2><a href='{0}' title='{1}'>{2}</a></h2></li>";j.find(".klwftr-news").prepend(String.format(f,b,i,c));if(j.find("ul.klwftr-news li").length>2){j.find("ul.klwftr-news li:last").hide()}}}else{j.find(".prM13").remove()}}if(j.find(".prM1").length>0){var e=j.find(".prM1").attr("lc");if(e==0||e==LC){j.find(".prM1").removeAttr("style");b=j.find(".klwftr-topnews:first > a").attr("href").trim();c=j.find(".klwftr-topnews:first .klwftrt-title a").text().trim();i=j.find(".klwftr-topnews:first > a").attr("title").trim();j.find(".klwftr-topnews:first").hide();var f="<li class='klwftrn'><h2><a href='{0}' title='{1}'>{2}</a></h2></li>";j.find(".klwftr-news").prepend(String.format(f,b,i,c));if(j.find("ul.klwftr-news li").length>2){j.find("ul.klwftr-news li:last").hide()}}else{j.find(".prM1").remove()}}},removeList:function(b){var a=this;$(a.divList).find('>li .knswli-title > a[href="'+b+'"]').parents("li").remove()},listAppend:function(h,d,j,g,m,k,f,l,c,b){var a=this;var e="<li class='knswli need-get-value-facebook clearfix' data-boxtype='NewsPublish'><div class='knswli-left fl'><a style=\"background-image:url('{1}')\" href='{0}' class='kscliw-ava' newsid='{7}' newstype='{9}' type='{12}' rel='newstype' title='{10}'></a></div><div class='knswli-right'><h3 class='knswli-title'><a href='{0}' data-id='{7}' newstype='{9}' type='{12}' rel='{8}' title='{10}'>{2}</a></h3><div class='knswli-meta'><a href='{3}' class='knswli-category'>{4}</a> - <span class='knswli-time' title='{5}'></span><span class='item-comment knswli-comment' href='{0}#mingid_comments_content' rel='{8}' style='display:none;'></span><span class='knswli-facebook item-fb' rel='{8}' style='display:none;'></span></div><span class='knswli-sapo sapo-need-trim'>{6}</span></div></li>";var i=$((String.format(e,d,j,g,"#",m,k,f,l,c,0,b,"","")));$(a.divList).find(">li:eq("+h+")").before(i)},duLichFocus:function(){var a=this;if($(a.divDuLichFocus).find(".ttn.prM800").length>0){var k=$(a.divDuLichFocus).find(".ttn.prM800").attr("lc");if(k==0||k==LC){$(a.divDuLichFocus).find(".ttn.prM800").removeAttr("style");if($(a.divDuLichFocus).find(".ttn").length>3){var e=$(a.divDuLichFocus).find(".ttn:visible:last");var c=e.find(" h3 > a").attr("href");var o=e.find(" h3 > a").attr("title");var j=e.find(".ttn-thumb>img").attr("src");var n=e.find(" h3 > a").attr("data-id");var i=e.find(" h3 > a").text();var h=e.find(" .ttn-sapo").text();var m=e.find(" .tn-time").attr("title");var l=0;a.listDuLichAppend(l,c,j,i,m,h,n,o);$(a.divDuLichList).find(">li:eq("+l+") .tn-sapo").trimLine(2);e.remove()}var g=$(a.divDuLichFocus).find(".ttn.prM800 a").attr("href");a.removeDuLichList(g)}else{$(a.divDuLichFocus).find(".ttn.prM800").remove()}}if($(a.divDuLichKenh14Choice).find(".tfv-video.prM801").length>0){var d=$(a.divDuLichKenh14Choice).find(".tfv-video.prM801").attr("lc");if(d==0||d==LC){var b=$(a.divDuLichKenh14Choice).find(".tfv-video:visible:last");b.remove();$(a.divDuLichKenh14Choice).find(".tfv-video.prM801").removeAttr("style")}else{$(a.divDuLichKenh14Choice).find(".tfv-video.prM801").remove()}}if($(a.divDuLichAnCaTheGioi).find(".tfv-video.prM802").length>0){var f=$(a.divDuLichAnCaTheGioi).find(".tfv-video.prM802").attr("lc");if(f==0||f==LC){console.log("mode802");var b=$(a.divDuLichAnCaTheGioi).find(".tfv-video:visible:last");b.remove();$(a.divDuLichAnCaTheGioi).find(".tfv-video.prM802").removeAttr("style")}else{$(a.divDuLichAnCaTheGioi).find(".tfv-video.prM802").remove()}}},listDuLichAppend:function(e,b,a,c,g,k,j,h){var i=this;var f="<li class='tsn-news normal clearfix'><a href='{1}' class='tn-thumb' title='{7}' newsid='{6}'><img src='{2}' alt='{7}'></a><div class='tn-info'><div class='tn-meta'><span class='tn-time date-time' title='{4}'></span></div><h3 class='tn-title'><a href='{1}' title='{7}'>{3}</a></h3><p class='tn-sapo'>{5}</p></div></li>";var d=$((String.format(f,"",b,a,c,g,k,j,h)));$(i.divDuLichList).find(">li:eq("+e+")").before(d)},removeDuLichList:function(b){var a=this;$(a.divDuLichList).find('>li .tn-title > a[href="'+b+'"]').parents("li").remove()},};var regionNews={isSouth:readCookie("__RC")==5,divHomeFocus:".klw-featured-news",divHomeTop1:".klwfn-left",divHomeTop2:".klwfn-right",divHomeTop7:".klwfn-slide-wrapper .list-klwfnswn",homeFocus:function(){var f=this;if(f.isSouth){var h=$.parseJSON($("#hidSouthHomeFocusNews").val());var d="";var a=h[0];var e="";e+="<div class='klwfn-left fl' newstype='"+a.Type+"' rel='wrapt-newstype'>";e+="   <a href='"+a.Url+"' title='"+a.Alt+"' class='klwfnl-thumb'>";e+="       <img src='"+a.Avatar460x289+"' alt='"+a.Alt+"'>";e+="   </a>";e+="   <h2 class='klwfnl-title'>";e+="       <a href='"+a.Url+"' title='"+a.Alt+"'>"+a.Title+"</a>";e+="   </h2>";e+="   <p class='klwfnl-sapo'>"+a.Sapo+"</p>";e+="</div>";d+=e;if(h.length>1){var g=h[1];var b="";b+="<div class='klwfn-right fr' newstype='"+g.Type+"' rel='wrapt-newstype'>";b+="    <a href='"+g.Url+"' title='"+g.Alt+"' class='klwfnr-thumb'>";b+="        <img src='"+g.Avatar460x289+"' alt='"+g.Alt+"'>";b+="    </a>";b+="    <h2 class='klwfnr-title'>";b+="        <a href='"+g.Url+"' title='"+g.Alt+"'>"+g.Title+"</a>";b+="    </h2>";b+="</div>";h.push(h[1])}h.push(h[0]);d+=b;$(f.divHomeFocus).find(f.divHomeTop2).remove();$(f.divHomeFocus).find(f.divHomeTop1).remove();$(f.divHomeFocus).prepend(d);var c="";$.each(h,function(k,j){if(k==0||k==1){return true}c+="<li class='klwfnswn swiper-slide' newstype='"+j.Type+"' rel='wrapt-newstype'>";c+=" <a href='"+j.Url+"' title='"+j.Alt+"' class='klwfnswn-thumb'>";c+="      <img src='"+j.Avatar280x175+"' alt='"+j.Alt+"'>";c+=" </a>";c+=" <h4 class='klwfnswn-title'>";c+="<a href='"+j.Url+"' title='"+j.Alt+"'>";c+=""+j.Title+"";c+="</a>";c+="</h4>";c+="</li>"});$(f.divHomeTop7).find("li").not(".prM13").remove();$(f.divHomeTop7).append(c)}}};var IMSInteractiveBasePath=("https:"==document.location.protocol?"https://":"http://")+"interactive.channelvn.net";function InitDetail(){InitBoxQuizz();getCountComment(".kbwc-socials");spnBeforeAfter.init();removeEmptyImage();formatLinkInDetail();formatShortVideoInDetail();equalWidthCaption()}var popupNews=function(){var k=document.title;var j=window.location.pathname;var c=0;var i=false;var d=0;var g="news";if(typeof(topicId)!="undefined"){d=topicId}if(typeof(topicname)!="undefined"){g=topicname}function h(m,p,n,o){$.ajax({url:m,dataType:"html",success:function(q){if(q+""==""){b();return}setTimeout(function(){$(".light-box").html("").append('<div class="ct-main"></div>');$(".light-box .ct-main").html(q);f();$(".light-box .link-content-footer").remove();$(".light-box .facebook-button-share").each(function(){var t=$(this).attr("data-url");var s=$(this);s.next().hide()});$(".light-box .facebook-button iframe").css("width","200px");$(".light-box .lb-news-content header img").css("max-width","100%");if($(".light-box-content").length>0){$(".light-box-content").scrollTop(0)}else{$(".light-box-bounder").scrollTop(0)}$("body").css({overflow:"hidden"});if(o){o()}document.title=p.title;if(!n){history.pushState(p,p.title,p.url)}var r=$(".light-box").offset().left+$(".light-box").width()-18;$(".close-wrap").css({position:"absolute",left:r}).show();setTimeout(function(){if($("#ContentFirstShort").is(":visible")){console.log("short");videoHD.isHideControlbar=false;videoHD.init("#ContentFirstShort",{type:videoHD.videoType.newsDetail})}else{console.log("full");videoHD.isHideControlbar=false;videoHD.init("#ContentFirstFull",{type:videoHD.videoType.newsDetail})}},2000);setTimeout(function(){if($(".light-box .threads").length>0){var t=0;var s=0;$(".light-box .threads li").each(function(){var u=$(this);s=u.outerHeight();if(s>t){t=s}})}$(".light-box  .VCSortableInPreviewMode .PhotoCMS_Caption").each(function(){if($(this).html()===""){$(this).remove()}else{var u=$(this).prev("div").find(">img").width();if(parseInt(u)>0){$(this).css({width:u,margin:"0 auto"})}}})},1500);ADM_PPTKSend.trackingPopup();$(".light-box-bounder").addClass("modal-open")},0)},error:function(){console.log("lỗi không lấy được dữ liệu");$(".light-box-bounder").fadeOut(50)}})}function l(m){var o=$("#first-krw-list .lb-news-content").height();var n=$("#first-krw-list .lb-banner").height();if(o==n){clearInterval(m);return}if(o>n){$("#first-krw-list .lb-banner").height($("#first-krw-list .lb-news-content").height())}else{$("#first-krw-list .lb-news-content").height($("#first-krw-list .lb-banner").height())}}function b(){document.title=refTitle;history.pushState({title:refTitle,url:refUrl,requestUrl:""},refTitle,refUrl);a();$(".close-wrap").hide();$(".light-box").addClass("loading");$(".light-box-bounder").fadeOut(50,function(){$("body").css({overflow:""})});var m=$('.lb-news-content .kbwc-video-cover .VCSortableInPreviewMode[type="VideoStream"]');if(m.length>0){m.each(function(p,n){var r=$(n);var o=r.attr("data-key");var q=$('.VCSortableInPreviewMode[data-key="'+o+'"] iframe');videoInContent.getCurrentTime("#"+r.find("iframe").attr("id"),{id:"#"+q.attr("id"),isSeek:true})})}$(".light-box-bounder").removeClass("modal-open");setTimeout(function(){videoInContent.stopAllVideo()},500)}function e(){if(!i){$(window).on("load",function(){setTimeout(function(){window.onpopstate=function(n){if(n.state){if(!n.state.url||n.state.url==popupNews.mainPageData().mainPageUrl){var o=$(".light-box-bounder").is(":hidden");if(!o){b();history.pushState(null,document.title,j)}else{window.history.back()}}else{var o=$(".light-box-bounder").is(":hidden");h(n.state.requestUrl,n.state,1,function(){$(".light-box").removeClass("loading").show();$(".light-box-content").scrollTop(0);setTimeout(function(){InitDetail();getFbData("total",false);getCountCommentLinkNotReturn(".light-box-content .kbwc-socials .item-comment",false);$(".knswli-time").timeago();fbClient.init();getCountView("light-box","lượt xem")},1500)});if(o){$(".light-box-bounder").hide().fadeIn(50)}}}else{var o=$(".light-box-bounder").is(":hidden");if(!o){b()}else{window.history.back()}}}},500)});var m;$(".light-box-content").on("click",function(n){if(n.target!==this){return}b()}).scroll(function(){if(m){clearTimeout(m);m=null}var n=$(this);m=setTimeout(function(){var p=n.scrollTop();var o=$(".lb-news-content.news-detail.expanded");$.each(o,function(){if(p>=$(this).position().top&&p<=$(this).position().top+$(this).outerHeight()){if(location.href.indexOf($(this).attr("data-url"))>=0){return}var r=$(this).attr("data-url");var q=$(this).find(".news-title").html();history.replaceState({title:q,url:r,requestUrl:$(this).attr("data-share")},q,r);document.title=q}})},0)});$(".light-box-bounder").on("click",".close",function(n){if(n.target!==this){return}b()});$(".light-box").on("click",".threads a",function(r){r.stopPropagation();var s=$(this);if(s.hasClass("no-popup")){return}r.preventDefault();var q=s.attr("href");var n=s.attr("title");var o=q.match(/[0-9]+\.chn/g)[0].replace(".chn","");var p=String.format(Constants.apiHandlerUrl+"/popup_news/{0}/{1}/{2}.chn",d,g,o);a();h(p,{title:n,url:q,requestUrl:p},0,function(){setTimeout(function(){InitDetail();getFbData("share",false);getCountCommentLinkNotReturn(".light-box-content .kbwc-socials .item-comment",false);$(".knswli-time").timeago();fbClient.init();getCountView("light-box","lượt xem")},1500)})}).on("click",".viewmore a",function(u){u.preventDefault();u.stopPropagation();var v=$(this);if(v.parent().parent().parent().attr("id")!="first-krw-list"){var q;var s=popupNews.mainPageData().mainPageUrl;q=v.attr("href").match(/[0-9]+\.chn/g)[0].replace(".chn","");var o=String.format(Constants.apiHandlerUrl+"/popup_news/{0}/{1}/{2}.chn",d,g,q);var n=v.attr("href");var t=v.attr("data-title");history.replaceState({title:t,url:n,requestUrl:o},t,n);document.title=t;var r=$(this).parent();r.prev().show();r.prev().prev().hide();r.hide().parent().addClass("expanded");r.prev().find(".VCSortableInPreviewMode .PhotoCMS_Caption").each(function(){if($(this).html()===""){$(this).remove()}else{var p=$(this).prev("div").find(">img").width();if(parseInt(p)>0){$(this).css({width:p,margin:"0 auto"})}}})}else{v.parent().parent().removeClass("max-height-3000");$("#ContentFirstShort").remove();videoHD.isHideControlbar=false;videoHD.init("#ContentFirstFull",{type:videoHD.videoType.newsDetail,useBg:false});setTimeout(function(){videoInPopup.init("#ContentFirstFull")},500)}equalWidthCaption()}).on("click",".facebook-button-share",function(n){n.preventDefault();var o=window.open($(this).attr("href"),"_blank","width=100px;height=100px")}).on("click",".kbwcs-comment-link",function(n){n.preventDefault();n.stopPropagation();history.pushState({title:refTitle,url:refUrl,requestUrl:""},refTitle,refUrl);window.location.href=$(this).attr("href");return false});$(".light-box").click(function(n){if(n.target!==this){return}});$(window).resize(function(){var n=$(".light-box").offset().left+$(".light-box").width()-18;$(".close-wrap").css({position:"absolute",left:n})});i=true}}function a(){$("#popup_ads_placeholder").append($("#popup_ads"));$("#popup-highlight-placeholder").append($("#popup-highlight"));try{$("#admzone1426").html("");admicroAD.loaded=ADS_CHECKER.array_diff(admicroAD.loaded,[1426])}catch(m){}}function f(){if($(".ct-main .lb-banner #popup_ads").length==0){$(".ct-main .lb-banner").append($("#popup_ads"));if(admicroAD.loaded!=undefined){var m=admicroAD.loaded.indexOf("1426");if(m<=0){admicroAD.unit.push(function(){admicroAD.show("admzone1426")})}}else{admicroAD.unit.push(function(){admicroAD.show("admzone1426")})}}}return{mainPageData:function(){return{mainPageTitle:k,mainPageUrl:j}},init:function(){e();popupNews.addNewsEventClick(".k14-topic-fancy");popupNews.addNewsEventClick(".avatar-video .kscliw-ava")},addNewsEventClick:function(m){$(m+":not(.done-click)").on("click",function(n){n.preventDefault();var q=$(this);var o=q.attr("href");var p=q.attr("title");$(".light-box-bounder").hide().fadeIn(50,function(){if($(".light-box .loading-image").length==0){$(".light-box").append('<div class="loading-image"><img src="https://kenh14cdn.com/web_images/popup-loading.gif" /> Loading...</div>').addClass("loading").show()}var t=q.attr("href").match(/[0-9]+\.chn/g)[0].replace(".chn","");var s=popupNews.mainPageData().mainPageUrl;var r=String.format(Constants.apiHandlerUrl+"/popup_news/{0}/{1}/{2}.chn",d,g,t);h(r,{title:p,url:o,requestUrl:r},0,function(){$(".light-box").removeClass("loading").find(".loading-image").remove();$(".light-box-content").scrollTop(0);setTimeout(function(){InitDetail();getFbData("share",false);$(".knswli-time").timeago();getCountCommentLinkNotReturn(".light-box-content .kbwc-socials .item-comment",false);fbClient.init();getCountView("light-box","lượt xem")},0)})})});$(m+":not[.done-click]").addClass("done-click")}}}();var poll=function(){var a={url:Constants.apiHandlerUrl+"/Handler/Detail/Vote.ashx"};var c={isVoting:false,isViewing:false};function d(g,h,i){if(c.isVoting){return}c.isVoting=true;$.ajax({url:a.url,data:{action:"vote",voteId:g,voteItemIds:h},error:function(){c.isVoting=false},success:function(j){vcCore.exec(i);c.isVoting=false}})}function e(g,i,h){if(c.isViewing){return}c.isViewing=true;ajax.vote.getResult(g,{dataType:"json",error:function(){c.isViewing=false},success:function(m){for(var k=0;k<i.length;k++){for(var l=0;l<m.length;l++){if(i[k].Id==m[l].Value){i[k].VoteRate=m[l].VoteRate;continue}}}f(g,i,h);c.isViewing=false}})}function b(n,j){if(n&&n.length>0){var m='<div id="VCPollView">';m+='<div id="popup-poll-left">';m+='    <div class="popup-poll-content">';m+='        <span class="p-text">Kết quả khảo sát:</span>';if($(".VoteObjectBoxTitle a").length>0){m+='        <h2 class="p-title">'+j+"</h2>"}else{m+='        <h2 class="p-title">'+$(".k14_poll_embed_p1 span").html()+"</h2>"}m+='        <span class="p-sapo">Bạn có thể chọn nhiều mục. Bình chọn của bạn sẽ được công khai</span>';m+="        <ul>";var g=0;for(var h=0,k=n.length;h<k;h++){var o=n[h];g+=o.VoteRate;m+="            <li>";m+='                <span class="p-vote-title">'+o.Value+"</span>";m+='                <span class="p-vote-percent" vote="'+o.VoteRate+'"><span style="width:0%;text-align:center;white-space:nowrap">'+o.VoteRate+" bình chọn</span></span>";m+="            </li>"}m+="        </ul>";m+="    </div>";m+="</div>";m+="</div>";$.fancybox.open({padding:0,content:m,beforeShow:function(){$("#VCPollView").parent(".fancybox-inner").parent(".fancybox-wrap").parent("#fancybox-lock").css({"background-color":"black"});$("#VCPollView").parent(".fancybox-inner").css({"border-width":"0","margin-left":"0","max-height":"none"});$("#VCPollView").parent(".fancybox-inner").parent(".fancybox-wrap").css({height:"auto!important",width:"800px",padding:"15px 0"})},onUpdate:function(){$(window).scroll(function(){try{$.fancybox.close().transitions()}catch(i){}})},nextEffect:"none",prevEffect:"none",openEffect:"none",closeEffect:"none",hideOnContentClick:true});$(".popup-poll-content ul li .p-vote-percent").each(function(){var i=parseInt($(this).attr("vote"));var l=g==0?0:(i/g*100);l=Math.round(l*100)/100;$(this).find("span").css("width",l+"%")})}}function f(s,q,x){if(q&&q.length>0){var h=0;var v=$(".VCSortableInPreviewMode[voteid="+s+"] .VCListVoteAnswers");v.find(".p-vote-percent").remove();var n=0;for(var p=0,u=q.length;p<u;p++){var k=q[p];n=n+k.VoteRate}n=parseInt(n);for(var o=0,r=q.length;o<r;o++){var t=q[o];var g=v.find("input[id=VoteAnswer"+t.Id+"]");if(g!=null){var m=(parseInt(t.VoteRate)/n)*100;var y='<span class="vote_percent" style="width: '+m+'%;"></span>';$(g).closest("p").find("label").after(y);$(g).closest("p").attr("title",Math.round(m)+"%")}}}}return{vote:function(n){if(n){n=$(n);var o=n.attr("voteid");var j="vote"+o;var h=vcCore.getCookie(j);var m=60000;var g=new Date();if(h){var r=parseInt((m-(g.getTime()-(new Date(h)).getTime()))/(1000));alert(String.format("Vui lòng bình chọn sau {0} phút {1} giây nữa.",parseInt(r/60),r%60));return}var q=n.closest('.VCSortableInPreviewMode[type="Vote"]');if(q&&q.length>0){var l=q.find("input:checked");if(l&&l.length>0){var s=[];l.each(function(){s.push($(this).val())});d(o,s.join(","),function(){vcCore.setCookie(j,g,new Date(g.getTime()+m));q.find(".VCPollViewResult:first").click()})}else{alert("Bạn chưa có lựa chọn nào.")}}else{var i=n.closest(".k14_poll_embed");var p=i.find('input[type="radio"]:checked');if(p&&p.length>0){var k=[];p.each(function(){k.push($(this).val())});d(o,k.join(","),function(){vcCore.setCookie(j,g,new Date(g.getTime()+m));i.find(".k14_poll_embed_b3:first").click()})}else{alert("Bạn chưa có lựa chọn nào.")}}}},view:function(m){if(m){m=$(m);var r=m.closest('.VCSortableInPreviewMode[type="Vote"]');var v=r.find(".VoteObjectBoxTitle > a").html();var p=m.attr("voteid");var j=[];var u=r.find("input");if(u&&u.length>0){for(var k=0,n=u.length;k<n;k++){var t=$(u[k]);var s=t.attr("id");var h=$(String.format('[for="{0}"]',s)).text();var q={Id:t.val(),VoteId:p,Value:h,VoteRate:0};j.push(q)}e(p,j,v)}else{var g=m.closest(".k14_poll_embed");var o=g.find('input[type="radio"]');for(var k=0,n=o.length;k<n;k++){var t=$(o[k]);var s=t.attr("id");var h=t.parent().find(".k14_poll_embed_s1").html();var q={Id:t.val(),VoteId:p,Value:h,VoteRate:0};j.push(q)}e(p,j,"")}}},init:function(){var g=$('.VCSortableInPreviewMode[type="Vote"]');g.each(function(k,h){var i=$(h);var j=i.attr("voteid");i.find(".VCPollFooter").html('<a href="javascript:;" onclick="poll.vote(this);" voteid="'+j+'" class="VCPollSubmit">Bình chọn</a><a href="javascript:;" onclick="poll.view(this);" voteid="'+j+'"  class="VCPollViewResult">Xem kết quả</a>')})}}}(jQuery);function checkVote(c){if(!$(c).is("input")){var a=$(c).find("input");var d="";if(a.attr("type")=="radio"){var b=$(c).parent("div").find("div");$(b).each(function(e){if($(this).hasClass("even")){$(this).css("background","#ececec")}else{if($(this).hasClass("odd")){$(this).css("background","")}}})}if($(c).hasClass("even")){d="#ececec"}else{d=""}if($(a).is(":checked")){$(a).attr("checked",false);$(c).css("background",d)}else{$(a).attr("checked",true);$(c).css("background",background_hover)}}else{var a=$(c);if($(a).is(":checked")){$(a).attr("checked",false)}else{$(a).attr("checked",true)}}}var ajax=function(){return{vote:{getResult:function(a,b){$.ajax($.extend(b,{url:Constants.apiHandlerUrl+"/vote-result.chn?voteId="+a+"&amp;action=view"}))}}}}(jQuery);var vcCore=function(){return{isAbsoluteUrl:function(a){return !vcCore.isEmpty(a)&&(a.indexOf("http://")==0||a.indexOf("https://")==0)},isSmartPhone:function(){return(navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|Windows Phone|webOS)/i)!=null)},isEmpty:function(a){return a==undefined||a==""||vcCore.isEmptyObject(a)},isEmptyObject:function(b){for(var a in b){return false}return true},isIE:function(){return $("html").hasClass("ie")},isIE7:function(){return $("html").hasClass("ie7")},isIE8:function(){return $("html").hasClass("ie8")},isIE9:function(){return $("html").hasClass("ie9")},addToCache:function(a,b){if(!b){b=a;a="js"+Math.floor(Math.random()*1000000)}vcCore[a]=b;return a},getFromCache:function(a){return vcCore[a]},exec:function(a){if(typeof a=="function"){a()}},getUrlParameter:function(a,b){return decodeURIComponent((new RegExp("[?|&]"+a+"=([^&;]+?)(&|#|;|$)").exec(b)||[,""])[1].replace(/\+/g,"%20"))||null},getCookie:function(d){var a=document.cookie;var c=a.indexOf(" "+d+"=");if(c==-1){c=a.indexOf(d+"=")}if(c==-1){a=null}else{c=a.indexOf("=",c)+1;var b=a.indexOf(";",c);if(b==-1){b=a.length}a=unescape(a.substring(c,b))}return a},setCookie:function(d,a,c){var b=escape(a)+((c==null)?"":"; expires="+c.toUTCString());document.cookie=d+"="+b},createObject:function(){return{}}}}(jQuery);var k14_kinglive={wrapper:".kinglive",status:-1,thumb:"",iframeSrc:"",classStatus:"",playerSrc:"https://vcplayer.mediacdn.vn/1.1/?_site=kinglive&vid=",usePlayerv1:false,player:null,isMute:true,initPlayer:function(k){var a=this;var c=$(k);var n=c.attr("data-width");var f=c.attr("data-height");var i=c.attr("data-vid");var h=c.attr("data-thumb");var g=c.attr("data-mp4");var e=true;var m="kinglive";var j=true;c.prepend('<video id="streamid_kinglive" playsinline="" webkit-playsinline="" height="'+f+'" width="'+n+'"></video>');var d={vid:i,autoplay:j,shareUrl:window.location.href,mute:e,nopre:true,poster:h,minimal:true,replay:true};try{var l="";playerInitScript("streamid_kinglive",{params:d,secure:l},function(){a.player=this;a.hoverTopMenu()})}catch(b){console.log(b)}},init:function(){var b=this;var a="LiveVideo";$.ajax({type:"GET",url:Constants.apiHandlerUrl+"/Handler/Video/KingliveHandler.ashx",data:({domain:"kenh14.vn",method:a}),dataType:"json",beforeSend:function(){},success:function(e){console.log(e);if(e!="{}"){b.status=e.status;switch(b.status){case 0:b.classStatus="liveEnded";if(e.config_on_site.on_stream==1){b.thumb=e.data.thumb;var c=(e.data.link_upload_vod!="null")?e.data.link_upload_vod:e.data.link_trailer;var i=(e.data.link_upload_vod!="null")?e.data.thumb:e.data.thumb_before_live;if(c!="null"){b.iframeSrc=b.playerSrc+encodeURI(c);$(b.wrapper).find(".VCSortableInPreviewMode").attr("data-src",b.iframeSrc);videoHD.init(b.wrapper,{useBg:false,type:videoHD.videoType.stream});videoInContent.init(b.wrapper);$(b.wrapper).find(".VCSortableInPreviewMode").removeClass("hidden");$(b.wrapper).find(".knswlicklv-wrapper").remove()}else{$(b.wrapper).find(".knswlicklvw-video-rendering").removeClass("hidden");$(b.wrapper).find(".knswlicklvw-video-rendering").css("background-image",'url("'+b.thumb+'")')}$(b.wrapper).find(".knswlickrll-text").removeClass("hidden");$(b.wrapper).find(".knswlickrll-text").html("Đã kết thúc");$(b.wrapper).find(".knswlickr-statistic").removeClass("hidden");if(e.data.total_view>0){var j=(e.data.total_view>=1000000)?"0.0a":"0,0a";e.data.total_view=numeral(e.data.total_view).format(j).replace(",",".");$(b.wrapper).find(".knswlickrsi.totalView .knswlickrsi-number").html(e.data.total_view)}if(e.data.total_comment>0){j=(e.data.total_comment>=1000000)?"0.0a":"0,0a";e.data.total_comment=numeral(e.data.total_comment).format(j).replace(",",".");$(b.wrapper).find(".knswlickrsi.totalComment .knswlickrsi-number").html(e.data.total_comment)}$(b.wrapper).find(".knswlickrsi.totalReact").hide();$(b.wrapper).find(".knswlickrlli-shape-camera").show();$(b.wrapper).find(".knswlickrlli-text").html("LIVE")}if(e.config_on_site.on_menu==1){$(".header-kinglive-status").addClass("liveEnded");$(".header-kinglive-status .broadcast-time").html("XEM VIDEO");var g=$('<svg width="12" height="7" viewBox="0 0 12 7"><path d="M8.990,1.770 L11.994,0.607 L11.994,6.418 L8.990,5.242 L8.990,6.432 C8.990,6.587 8.931,6.721 8.815,6.835 C8.697,6.949 8.559,7.006 8.400,7.006 L0.610,7.006 C0.441,7.006 0.298,6.949 0.181,6.835 C0.064,6.721 0.006,6.587 0.006,6.432 L0.006,0.594 C0.006,0.430 0.064,0.291 0.181,0.177 C0.298,0.063 0.441,0.006 0.610,0.006 L8.400,0.006 C8.559,0.006 8.697,0.063 8.815,0.177 C8.931,0.291 8.990,0.430 8.990,0.594 L8.990,1.770 L8.990,1.770 Z" fill= "#fff"></path></svg>');$(".header-kinglive-status .broadcast-icon svg").remove();$(".header-kinglive-status .broadcast-icon").append(g);var c=(e.data.link_upload_vod!="null")?e.data.link_upload_vod:e.data.link_trailer;var i=(e.data.link_upload_vod!="null")?e.data.thumb:e.data.thumb_before_live;if(c!="null"){if(b.usePlayerv1){$(".header-kinglive-status .kinglive-vp-wrapper").append('<iframe src="https://vcplayer.mediacdn.vn/1.1/?_site=kinglive&mute=true&vtype=2&playType=0&replay=true&autoplay=true4&control=false&vid='+encodeURI(c)+'" id="ifVideo-videoid_kinglive_top" frameborder="0" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" oallowfullscreen="" msallowfullscreen="" scrolling="no"></iframe>')}else{$(".header-kinglive-status .kinglive-vp-wrapper").attr("data-vid",c);$(".header-kinglive-status .kinglive-vp-wrapper").attr("data-thumb",i);b.initPlayer(".header-kinglive-status .kinglive-vp-wrapper")}}}break;case 1:b.classStatus="nowlive";b.iframeSrc=e.data.link_end+"&autoplay=true&mute=true";if(e.config_on_site.on_stream==1){$(b.wrapper).find("iframe").attr("src",b.iframeSrc);$(b.wrapper).find("iframe").removeClass("hidden");b.thumb=e.data.thumb;var j=(e.data.total_view>=1000000)?"0.0a":"0,0a";e.data.total_view=numeral(e.data.total_view).format(j).replace(",",".");$(b.wrapper).find(".knswlickrll-view").removeClass("hidden");$(b.wrapper).find(".knswlickrll-view .knswlickrllv-count").html(e.data.total_view);$(b.wrapper).find(".knswlickrlli-shape-circle").show()}if(e.config_on_site.on_menu==1){$(".header-kinglive-status").addClass("nowlive");$(".header-kinglive-status .broadcast-time").html("ĐANG TRỰC TIẾP");$(".header-kinglive-status .kinglive-vp-wrapper").append('<iframe src="'+b.iframeSrc+'&minimal=true" id="ifVideo-videoid_kinglive_top" frameborder="0" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" oallowfullscreen="" msallowfullscreen="" scrolling="no"></iframe>')}break;case 2:b.classStatus="upcoming";var d=new Date(e.data.start_time_on_site);var f=new Date();var h=d.getHours()+":"+d.getMinutes();if(d.getMonth()==f.getMonth()&&d.getFullYear()==f.getFullYear()){if(d.getDate()==f.getDate()){h+=" Hôm nay"}else{if(d.getDate()==f.getDate()+1){h+=" Ngày mai"}else{h+=" "+d.getDate()+"/"+(d.getMonth()+1)+"/"+d.getFullYear()}}}if(e.config_on_site.on_stream==1){if(e.data.link_trailer!="null"){b.iframeSrc=b.playerSrc+encodeURI(e.data.link_trailer);$(b.wrapper).find(".VCSortableInPreviewMode").attr("data-src",b.iframeSrc);videoHD.init(b.wrapper,{useBg:false,type:videoHD.videoType.stream});videoInContent.init(b.wrapper);$(b.wrapper).find(".VCSortableInPreviewMode").removeClass("hidden");$(b.wrapper).find(".knswlicklv-wrapper").remove()}else{b.thumb=e.data.thumb_before_live;$(b.wrapper).find(".knswlicklv-thumb").removeClass("hidden")}$(b.wrapper).find(".knswlickrll-text").removeClass("hidden");$(b.wrapper).find(".knswlickrll-text").html(h);$(b.wrapper).find(".knswlickrlli-shape-camera").show();$(b.wrapper).find(".knswlickrlli-text").html("LIVE")}if(e.config_on_site.on_menu==1){$(".header-kinglive-status .broadcast-time").html(h);if(e.data.link_trailer!="null"){var c=e.data.link_trailer;if(b.usePlayerv1){$(".header-kinglive-status .kinglive-vp-wrapper").append('<iframe src="https://vcplayer.mediacdn.vn/1.1/?_site=kinglive&mute=true&vtype=2&playType=0&replay=true&autoplay=true4&control=false&vid='+encodeURI(c)+'" id="ifVideo-videoid_kinglive_top" frameborder="0" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" oallowfullscreen="" msallowfullscreen="" scrolling="no"></iframe>')}else{$(".header-kinglive-status .kinglive-vp-wrapper").attr("data-vid",c);$(".header-kinglive-status .kinglive-vp-wrapper").attr("data-thumb",e.data.thumb_before_live);b.initPlayer(".header-kinglive-status .kinglive-vp-wrapper")}}}break;default:$(b.wrapper).remove();$(".header-kinglive-status").remove();return;break}if(e.config_on_site.on_stream==1){$(b.wrapper).find(".knswli-sapo").html(e.data.description);$(b.wrapper).find(".knswli-title a").html(e.data.title);$(b.wrapper).find(".knswli-title a").attr("title",e.data.title);if(e.data.link_custom!="null"){$(b.wrapper).find(".knswli-title a").attr("href",e.data.link_custom)}if(b.thumb!=""){$(b.wrapper).find(".knswlicklv-thumb").attr("src",b.thumb);$(b.wrapper).find(".knswlicklv-thumb").attr("alt",e.data.title)}$(b.wrapper).find(".knswlic-kinglive").addClass(b.classStatus);if(b.status>=0){$(b.wrapper).removeClass("hidden")}}else{$(b.wrapper).remove()}if(e.config_on_site.on_menu==1){$(".kinglive-btn").hover(function(){$("body").toggleClass("kingliveActive")});$(".header-kinglive-status").removeClass("hidden");$(".header-kinglive-status .kinglive-btn-info b").html(e.data.title);if(e.data.link_custom!="null"){$(".header-kinglive-status .kinglive-btn").attr("href",e.data.link_custom)}}else{$(".header-kinglive-status").remove()}}else{$(b.wrapper).remove()}}})},hoverTopMenu:function(){var a=this;if(a.player!=null){$(".header-kinglive-status").hover(function(){a.isMute=!a.isMute;a.player.muted(a.isMute)})}}};var liveEmbed={status:-1,thumb:"",iframeSrc:"",classStatus:"",playerSrc:"https://vcplayer.mediacdn.vn/1.1/?_site=kenh14&vid=",usePlayerv1:false,player:null,isMute:true,apiHandlerUrl:"https://kenh14s1.cnnd.vn",initPlayer:function(k){var a=this;var c=$(k);var n=c.attr("data-width");var f=c.attr("data-height");var i=c.attr("data-vid");var h=c.attr("data-thumb");var g=c.attr("data-mp4");var e=true;var m="kenh14";var j=true;c.prepend('<video id="streamid_kinglive" playsinline="" webkit-playsinline="" height="'+f+'" width="'+n+'"></video>');var d={vid:i,autoplay:j,shareUrl:window.location.href,mute:e,nopre:true,poster:h,minimal:true,replay:true};try{var l="";playerInitScript("streamid_kinglive",{params:d,secure:l},function(){a.player=this;a.hoverTopMenu()})}catch(b){console.log(b)}},init:function(){var b=this;var a="LiveVideo";$.ajax({type:"GET",url:b.apiHandlerUrl+"/Handler/RequestHandlers.ashx",data:{c:"wcembed",id:1},dataType:"json",beforeSend:function(){},success:function(f){console.log(f);if(f!="{}"){b.status=f.status;switch(b.status){case 0:b.classStatus="upcoming";$(".header-kinglive-status .broadcast-time").html(f.start_time_on_site+" - TRỰC TIẾP");if(f.link_trailer!="null"){var c=f.link_trailer;if(b.usePlayerv1){$(".header-kinglive-status .kinglive-vp-wrapper").append('<iframe src="https://vcplayer.mediacdn.vn/1.1/?_site=kenh14&mute=true&vtype=2&playType=0&replay=true&autoplay=true4&control=false&vid='+encodeURI(c)+'" id="ifVideo-videoid_kinglive_top" frameborder="0" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" oallowfullscreen="" msallowfullscreen="" scrolling="no"></iframe>')}else{$(".header-kinglive-status .kinglive-vp-wrapper").attr("data-vid",c);$(".header-kinglive-status .kinglive-vp-wrapper").attr("data-thumb",f.thumb);b.initPlayer(".header-kinglive-status .kinglive-vp-wrapper")}}$(".header-kinglive-status .kinglive-btn-info b").html(f.title);if(f.link_custom!="null"){$(".header-kinglive-status .kinglive-btn").attr("href",f.link_custom)}break;case 1:b.classStatus="nowlive";b.iframeSrc=f.link_end+"&autoplay=true&mute=true";$(".header-kinglive-status").addClass("nowlive");$(".header-kinglive-status .broadcast-time").html("ĐANG TRỰC TIẾP");$(".header-kinglive-status .kinglive-vp-wrapper").append('<iframe src="'+b.iframeSrc+'&minimal=true" id="ifVideo-videoid_kinglive_top" frameborder="0" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" oallowfullscreen="" msallowfullscreen="" scrolling="no"></iframe>');$(".header-kinglive-status .kinglive-btn-info b").html(f.title);if(f.link_custom!="null"){$(".header-kinglive-status .kinglive-btn").attr("href",f.link_custom)}break;case 2:b.classStatus="liveEnded";$(".header-kinglive-status").addClass("liveEnded");$(".header-kinglive-status .broadcast-time").html("XEM VIDEO");var d=$('<svg width="12" height="7" viewBox="0 0 12 7"><path d="M8.990,1.770 L11.994,0.607 L11.994,6.418 L8.990,5.242 L8.990,6.432 C8.990,6.587 8.931,6.721 8.815,6.835 C8.697,6.949 8.559,7.006 8.400,7.006 L0.610,7.006 C0.441,7.006 0.298,6.949 0.181,6.835 C0.064,6.721 0.006,6.587 0.006,6.432 L0.006,0.594 C0.006,0.430 0.064,0.291 0.181,0.177 C0.298,0.063 0.441,0.006 0.610,0.006 L8.400,0.006 C8.559,0.006 8.697,0.063 8.815,0.177 C8.931,0.291 8.990,0.430 8.990,0.594 L8.990,1.770 L8.990,1.770 Z" fill= "#fff"></path></svg>');$(".header-kinglive-status .broadcast-icon svg").remove();$(".header-kinglive-status .broadcast-icon").append(d);var c=(f.link_upload_vod!="null")?f.link_upload_vod:f.link_trailer;var e=f.thumb;if(c!="null"){if(b.usePlayerv1){$(".header-kinglive-status .kinglive-vp-wrapper").append('<iframe src="https://vcplayer.mediacdn.vn/1.1/?_site=kenh14&mute=true&vtype=2&playType=0&replay=true&autoplay=true4&control=false&vid='+encodeURI(c)+'" id="ifVideo-videoid_kinglive_top" frameborder="0" allowfullscreen="" webkitallowfullscreen="" mozallowfullscreen="" oallowfullscreen="" msallowfullscreen="" scrolling="no"></iframe>')}else{$(".header-kinglive-status .kinglive-vp-wrapper").attr("data-vid",c);$(".header-kinglive-status .kinglive-vp-wrapper").attr("data-thumb",e);b.initPlayer(".header-kinglive-status .kinglive-vp-wrapper")}}$(".header-kinglive-status .kinglive-btn-info b").html(f.title);if(f.link_custom!="null"){$(".header-kinglive-status .kinglive-btn").attr("href",f.link_custom)}break}if(b.status>=0){$(".khw-top-header").css("z-index",99999);$(".header-kinglive-status").removeClass("hidden")}}}})},hoverTopMenu:function(){var a=this;if(a.player!=null){$(".header-kinglive-status").hover(function(){a.isMute=!a.isMute;a.player.muted(a.isMute)})}}};var videonews={playerSrc:"https://vcplayer.mediacdn.vn/1.1/?_site=kenh14&vid=",init:function(){var a=this;var b=0;try{$(".video-item").each(function(){var i=$(this);var l=i.attr("data-htmlcode");try{if(l==null||l==""){i.css("display","none")}else{var w='<div class="VCSortableInPreviewMode active" data-width="700px" data-height="394px" type="VideoStream"  data-vid="" id="" videoid=""  data-thumb ="" data-location="" data-info="" data-ads="true"  data-contentId="" data-namespace=""></div>';var r='<div class="VCSortableInPreviewMode active" data-width="250px" data-height="163px" type="VideoStream"  data-vid="" id="" videoid=""  data-thumb ="" data-location="" data-info="" data-ads="true"  data-contentId="" data-namespace=""></div>';var n='<video id="myVideo" width="325" height="163" autoplay="true" loop="true" muted><source id="sourcevideo" src = "" type = "video/mp4" ></video>';var f=JSON.parse(l);if(i.hasClass("live-video")){var x=f.vid;var u='<div style="width:700px;height:394px;" class="ovp-video-embed" data-vid="'+x+'"></div>';i.find(".knswli-left .video-thumb-iframe").prepend(u);i.find(".knswli-left .video-thumb-iframe").each(function(){var B=$(this);var A=$(".ovp-video-embed",B).attr("data-vid");var h='<video id= "video_'+A+'"></video>';$(".ovp-video-embed",B).append(h);OVPPlayerInitScript("video_"+A+"",{v:A,params:{autoplay:true}},function(){var C=this})})}else{var m=f.video_filename;m=m.replace("https://hls.mediacdn.vn/","");var p=a.playerSrc+f.video_namespace+"/"+encodeURI(f.video_filename);p=p.replace("kenh14/https://hls.mediacdn.vn/kenh14","kenh14");var t=i.attr("data-videoid");if(f.video_format=="1"){i.find(".knswli-left .video-thumb-iframe").prepend(w);i.addClass("video-play-inline");i.find(".VCSortableInPreviewMode").attr("id","videoid_"+t);i.find(".VCSortableInPreviewMode").attr("videoid",t);i.find(".VCSortableInPreviewMode").attr("data-vid",m);i.find(".VCSortableInPreviewMode").attr("data-thumb",f.video_thumb);i.find(".video-news-label").css("display","none");i.find(".video-item-icon").css("display","none");var k=i.find(".knswli-category").text()}else{if(f.video_format=="0"){i.find(".knswlim-statistic-count").css("display","none");var j=f.video_duration;i.find(".knswli-sapo").trimLine(3);i.find(".knswli-left .video-thumb-iframe").prepend(n);var d=m.replace("kenh14/","");var e=f.video_duration;var o="p_00:00:10";if(e!=null||e==""){var g=e.split(":");if(g[1]>20){o="p_00:00:20"}else{o="p_00:00:05"}}i.find("#sourcevideo").attr("src","http://hls.mediacdn.vn/kenh14/animated_thumb/"+o+"/"+d);if(j!=null&&j!=""){var s=j.split(":");if(s!=null){var z=s[0];var v=s[1];var q=s[2];q=q.split(".")[0];if(z=="00"){f.video_duration=v+":"+q}else{f.video_duration=z+":"+v}}}i.find(".vtld-number").text(f.video_duration);var k=i.find(".knswli-category").text();if(k=="Video News"){i.find(".knswli-category").hide();i.find(".gach").hide()}else{i.find(".video-news-label").hide()}}}}i.find(".need-get-view").attr("rel",m)}}catch(y){console.log("json tra ve bi sai");$(this).hide()}});getViewVideoByFilename(".video-item","",false,false);$(".vtl-view-count").each(function(){if($(this).find("b").text()==0||$(this).find("b").text()==null||$(this).find("b").text()==""){$(this).find("i").hide()}});getCountComment(".video-item");getFbDataByObj(".video-item .item-fb","",false,true);videoHD.init(".video-item",{useBg:false,type:videoHD.videoType.stream,isHideControlbar:true,isAd:false});$(".knswlimsc.comment").each(function(){if($(this).find(".item-comment-loaded").text()==0){$(this).hide()}});$(".knswlimsc.facebook").each(function(){if($(this).find(".item-comment-loaded").text()==0){$(this).hide()}})}catch(c){console.log(c)}}};$(function(){if($('.VCSortableInPreviewMode[type="LiveEmbed"]').length>0){$('.VCSortableInPreviewMode[type="LiveEmbed"]').each(function(){var b=$(this).find(".ovp-video-embed").attr("data-vid");var c=$(this);var a='<video id= "video_'+b+'"></video>';$(this).find(".ovp-video-embed").append(a);OVPPlayerInitScript("video_"+b+"",{v:b,params:{autoplay:false}},function(){var d=this})})}});/* Copyright (c) 2011 Piotr Rochala (http://rocha.la)
 * Dual licensed under the MIT (http://www.opensource.org/licenses/mit-license.php)
 * and GPL (http://www.opensource.org/licenses/gpl-license.php) licenses.
 *
 * Version: 1.3.8
 *
 */
(function(a){a.fn.extend({slimScrollOnlyDrag:function(d){var c={width:"auto",height:"250px",size:"7px",color:"#000",position:"right",distance:"1px",start:"top",opacity:0.4,alwaysVisible:false,disableFadeOut:false,railVisible:false,railColor:"#333",railOpacity:0.2,railDraggable:true,railClass:"slimScrollRail",barClass:"slimScrollBar",wrapperClass:"slimScrollDiv",allowPageScroll:false,wheelStep:20,touchScrollStep:200,borderRadius:"7px",railBorderRadius:"7px"};var b=a.extend(c,d);this.each(function(){var A,z,r,f,g,i,q,E,w="<div></div>",C=30,x=false;var e=a(this);if(e.parent().hasClass(b.wrapperClass)){var j=e.scrollTop();B=e.siblings("."+b.barClass);y=e.siblings("."+b.railClass);l();if(a.isPlainObject(d)){if("height" in d&&d.height=="auto"){e.parent().css("height","auto");e.css("height","auto");var D=e.parent().parent().height();e.parent().css("height",D);e.css("height",D)}else{if("height" in d){var o=d.height;e.parent().css("height",o);e.css("height",o)}}if("scrollTo" in d){j=parseInt(b.scrollTo)}else{if("scrollBy" in d){j+=parseInt(b.scrollBy)}else{if("destroy" in d){B.remove();y.remove();e.unwrap();return}}}n(j,false,true)}return}else{if(a.isPlainObject(d)){if("destroy" in d){return}}}b.height=(b.height=="auto")?e.parent().height():b.height;var u=a(w).addClass(b.wrapperClass).css({position:"relative",overflow:"hidden",width:b.width,height:b.height});e.css({overflow:"hidden",width:b.width,height:b.height});var y=a(w).addClass(b.railClass).css({width:b.size,height:"100%",position:"absolute",top:0,display:(b.alwaysVisible&&b.railVisible)?"block":"none","border-radius":b.railBorderRadius,background:b.railColor,opacity:b.railOpacity,zIndex:90});var B=a(w).addClass(b.barClass).css({background:b.color,width:b.size,position:"absolute",top:0,opacity:b.opacity,display:b.alwaysVisible?"block":"none","border-radius":b.borderRadius,BorderRadius:b.borderRadius,MozBorderRadius:b.borderRadius,WebkitBorderRadius:b.borderRadius,zIndex:99});var m=(b.position=="right")?{right:b.distance}:{left:b.distance};y.css(m);B.css(m);e.wrap(u);e.parent().append(B);e.parent().append(y);if(b.railDraggable){B.bind("mousedown",function(h){var F=a(document);r=true;t=parseFloat(B.css("top"));pageY=h.pageY;F.bind("mousemove.slimscroll",function(G){currTop=t+G.pageY-pageY;B.css("top",currTop);n(0,B.position().top,false)});F.bind("mouseup.slimscroll",function(G){r=false;k();F.unbind(".slimscroll")});return false}).bind("selectstart.slimscroll",function(h){h.stopPropagation();h.preventDefault();return false})}y.hover(function(){p()},function(){k()});B.hover(function(){z=true},function(){z=false});e.hover(function(){A=true;p();k()},function(){A=false;k()});e.bind("touchstart",function(F,h){if(F.originalEvent.touches.length){g=F.originalEvent.touches[0].pageY}});e.bind("touchmove",function(F){if(!x){F.originalEvent.preventDefault()}if(F.originalEvent.touches.length){var h=(g-F.originalEvent.touches[0].pageY)/b.touchScrollStep;n(h,true);g=F.originalEvent.touches[0].pageY}});l();if(b.start==="bottom"){B.css({top:e.outerHeight()-B.outerHeight()});n(0,true)}else{if(b.start!=="top"){n(a(b.start).position().top,null,true);if(!b.alwaysVisible){B.hide()}}}v(this);function s(G){return;if(!A){return}var G=G||window.event;var F=0;if(G.wheelDelta){F=-G.wheelDelta/120}if(G.detail){F=G.detail/3}var h=G.target||G.srcTarget||G.srcElement;if(a(h).closest("."+b.wrapperClass).is(e.parent())){n(F,true)}if(G.preventDefault&&!x){G.preventDefault()}if(!x){G.returnValue=false}}function n(F,J,H){x=false;var I=F;var G=e.outerHeight()-B.outerHeight();if(J){I=parseInt(B.css("top"))+F*parseInt(b.wheelStep)/100*B.outerHeight();I=Math.min(Math.max(I,0),G);I=(F>0)?Math.ceil(I):Math.floor(I);B.css({top:I+"px"})}q=parseInt(B.css("top"))/(e.outerHeight()-B.outerHeight());I=q*(e[0].scrollHeight-e.outerHeight());if(H){I=F;var h=I/e[0].scrollHeight*e.outerHeight();h=Math.min(Math.max(h,0),G);B.css({top:h+"px"})}e.scrollTop(I);e.trigger("slimscrolling",~~I);p();k()}function v(h){if(window.addEventListener){h.addEventListener("DOMMouseScroll",s,false);h.addEventListener("mousewheel",s,false)}else{document.attachEvent("onmousewheel",s)}}function l(){i=Math.max((e.outerHeight()/e[0].scrollHeight)*e.outerHeight(),C);B.css({height:i+"px"});var h=i==e.outerHeight()?"none":"block";B.css({display:h})}function p(){l();clearTimeout(f);if(q==~~q){x=b.allowPageScroll;if(E!=q){var h=(~~q==0)?"top":"bottom";e.trigger("slimscroll",h)}}else{x=false}E=q;if(i>=e.outerHeight()){x=true;return}B.stop(true,true).fadeIn("fast");if(b.railVisible){y.stop(true,true).fadeIn("fast")}}function k(){if(!b.alwaysVisible){f=setTimeout(function(){if(!(b.disableFadeOut&&A)&&!z&&!r){B.fadeOut("slow");y.fadeOut("slow")}},1000)}}});return this}});a.fn.extend({slimscroll:a.fn.slimScroll})})(jQuery);